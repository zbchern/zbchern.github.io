(function() {
    ...
    */
    ...
    function Aa(a) {
        ...
        (b = a.l = a.l || b) ? b.Cb ? a.i = a.o || a.s : void 0 != b.u && a.s < b.u ? (a.i = b.u, a.l = null) : a.i = a.s: a.i = 0
    }
    ...
    function Ea(a, b, c, d) {
        try {
            ...
            return a.i.m = null, ta(a.i, g), Fa(a)
        }
        a.i.m = null;
        d.call(a.i, f);
        return Fa(a)
    ...
    function Ga(a) {
        this.next = function(b) {
            sa(a.i);
            a.i.m ? b = Ea(a, a.i.m.next, b, a.i.v) : (a.i.v(b), b = Fa(a));
            return b
        };
        this.throw = function(b) {
            sa(a.i);
            a.i.m ? b = Ea(a, a.i.m["throw"], b, a.i.v) : (ta(a.i, b), b = Fa(a));
            return b
        };
    ...
    n("Promise", function(a) {
        ...
        b.prototype.N = function(g) {
            ...
            "function" == typeof h ? this.oa(h, g) : this.o(g)
        };
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var m = q(g), p = m.next(); !p.done; p = m.next()) d(p.value).La(h, k)
            })
        };
        b.all = function(g) {
            var h = q(g),
            ...
            return k.done ? d([]) : new b(function(m, p) {
                ...
                var x = [],
                    v = 0;
                do x.push(void 0), v++, d(k.value).La(t(x.length - 1), p), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function Gb(a) {
        if (a instanceof Eb && a.constructor === Eb) return a.l;
        Ma(a);
    ...
    function Lb(a) {
        if (a instanceof Jb && a.constructor === Jb) return a.l;
        Ma(a);
        return "type_error:SafeUrl"
    }
    var Mb = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
        Kb = {},
        Nb = new Jb("about:invalid#zClosurez", Kb);
    ...
    function Ub(a, b) {
        b instanceof Jb || b instanceof Jb || (b = "object" == typeof b && b.j ? b.i() : String(b), Mb.test(b) || (b = "about:invalid#zClosurez"), b = new Jb(b, Kb));
        a.href = Lb(b)
    }
    ...
    function kc(a) {
        ...
        e.push(a.slice(c));
        return e.join("").replace(jc, "$1")
    };
    var lc = {};

    function mc(a) {
        if (a !== lc) throw Error("requires a valid immutable API token");
    };
    ...
    var pc = B("Opera"),
        tc = B("Trident") || B("MSIE"),
        uc = B("Edge"),
        vc = B("Gecko") && !(-1 != Ob().toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"),
        wc = -1 != Ob().toLowerCase().indexOf("webkit") && !B("Edge"),
        xc = B("Android");
    ...
    !B("Android") || Pb();
    Pb();
    var Jc = B("Safari") && !(Pb() || B("Coast") || B("Opera") || B("Edge") || B("Edg/") || B("OPR") || B("Firefox") || B("FxiOS") || B("Silk") || B("Android")) && !(nc() || B("iPad") || B("iPod"));
    var Kc = {},
        Lc = null;
    ...
    function Qc(a) {
        if (Oc !== Oc) throw Error("illegal external caller");
        this.da = a;
    ...
    function Sc(a, b) {
        Object.isFrozen(a) || (Rc ? a[Rc] |= b : void 0 !== a.la ? a.la |= b : Object.defineProperties(a, {
            la: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function Uc(a) {
        return Array.isArray(a) ? !!(Tc(a) & 1) : !1
    }
    ...
    function Wc(a) {
        return Array.isArray(a) ? !!(Tc(a) & 2) : !1
    }
    ...
    function Yc(a, b) {
        ...
        b ? Sc(a, 8) : Object.isFrozen(a) || (Rc ? a[Rc] &= -9 : void 0 !== a.la && (a.la &= -9))
    };
    ...
    var ad, bd = Object.freeze(Vc([]));

    function cd(a) {
        if (Zc(a)) throw Error("Cannot mutate an immutable Message");
    }
    ...
    function kd(a, b) {
        a instanceof b || id(Error("Expected instanceof " + jd(b) + " but got " + (a && jd(a.constructor))));
        return a
    }
        ...
        switch (typeof a) {
            ...
            case "object":
                if (a && !Array.isArray(a)) {
                    if (Nc && null != a && a instanceof Uint8Array) return Mc(a);
                    if (a instanceof Qc) {
                        var b = a.da;
                        null != b && "string" !== typeof b && (Nc && b instanceof Uint8Array ? b = Mc(b) : (Ma(b), b = null));
                        return (a.da = b) || ""
                    }
                }
        }
    ...
    function qd(a, b) {
        if (null != a) {
            if (Array.isArray(a)) a = pd(a, b);
            else if ($c(a)) {
                var c = {},
                    d;
                for (d in a) c[d] = qd(a[d], b);
                a = c
            } else a = b(a);
            return a
        }
    ...
    function pd(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = qd(c[d], b);
        Uc(a) && Vc(c);
        return c
    }
    ...
    function rd(a) {
        ...
        a = md(a);
        return Array.isArray(a) ? nd(a, rd) : a
    }
    ...
    function sd(a) {
        return a.j || (a.j = a.G[a.l + a.ja] = {})
    }

    function td(a, b, c) {
        return -1 === b ? null : b >= a.l ? a.j ? a.j[b] : void 0 : (void 0 === c ? 0 : c) && a.j && (c = a.j[b], null != c) ? c : a.G[b + a.ja]
    }

    function C(a, b, c, d, e) {
        d = void 0 === d ? !1 : d;
        (void 0 === e ? 0 : e) || cd(a);
        b < a.l && !d ? a.G[b + a.ja] = c : sd(a)[b] = c;
        return a
    }
    ...
    function ud(a, b, c, d) {
        c = void 0 === c ? !0 : c;
        var e = td(a, b, d);
        Array.isArray(e) || (e = bd);
        if (Zc(a)) c && (Xc(e), Object.freeze(e));
        else if (e === bd || Wc(e)) e = Vc(e.slice()), C(a, b, e, d);
        return e
    }

    function vd(a, b, c, d) {
        cd(a);
        (c = wd(a, c)) && c !== b && null != d && (a.i && c in a.i && (a.i[c] = void 0), C(a, c));
        return C(a, b, d)
    }
    ...
    function wd(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != td(a, e) && (0 !== c && C(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function xd(a, b, c, d, e) {
        ...
        if (-1 === c) d = null;
            ...
            if (g) d = g;
                ...
                var h = td(a, c, f);
                b = ld(h, b, d);
                void 0 == b ? d = g : (d && b.G !== h && C(a, c, b.G, f, !0), a.i[c] = b, Zc(a) && Xc(b.G), d = b)
            }
        }
        if (null == d) return d;
        Zc(d) && !Zc(a) && (d = d.mb(lc), C(a, c, d.G, e), a.i[c] = d);
        return d
    }
    ...
    function yd(a, b, c, d) {
        ...
        if (!f) {
            ...
            for (var h = 0; h < d.length; h++) {
                ...
                e = e || Wc(k);
                k = ld(k, b);
                void 0 !== k && (f.push(k), g && Xc(k.G))
            }
            g && (Xc(f), Object.freeze(f));
            a.i[c] = f;
            Yc(d, !e)
        }
        return f
    ...
    function Cd(a, b, c) {
        ...
        a || (a = d ? [d] : []);
        this.ja = (d ? 0 : -1) - (this.constructor.i || 0);
        this.i = void 0;
        this.G = a;
        a: {
            ...
            void 0 !== b && -1 < b ? (this.l = Math.max(b, a + 1 - this.ja), this.j = void 0) : this.l = Number.MAX_VALUE
        }
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.ja, (d = this.G[a]) ? Array.isArray(d) && Vc(d) : this.G[a] = bd;
                else {
                    d = sd(this);
                    var e = d[a];
                    e ? Array.isArray(e) && Vc(e) : d[a] = bd
                }
    }
    ...
    Cd.prototype.isMutable = function(a) {
        mc(a);
        return !Zc(this)
    };
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length) {
                            ...
                            if (h) {
                                for (h = 0; h < f.length; h++)(k = f[h]) && Zc(k) && !m && (f[h] = f[h].mb(lc), g[h] = f[h].G);
                                Yc(g, !0)
                            }
                            for (m = 0; m < Math.min(f.length, e.length); m++) Ed(f[m], e[m])
                        }
                    } else(f = xd(a, e.constructor,
                        g, void 0, f)) && Ed(f, e)
                }
            }
        }
    ...
    if (dd) {
        var Hd = {};
        Object.defineProperties(Gd, (Hd[Symbol.hasInstance] = hd(function() {
        ...
        if (a = a.i && a.i[c])
            if (Array.isArray(a)) {
                ...
                if (null != e) {
                    d = Vc([]);
                    a = !1;
                    for (var g = 0; g < e.length; g++) d[g] = kd(e[g], f).G, a = a || Wc(d[g]);
                    b.i || (b.i = {});
                    b.i[c] = e;
                    Yc(d, !a)
                } else b.i && (b.i[c] = void 0), d = bd;
                C(b, c, d)
            } else E(b, a.constructor, c, a);
        else Nc && d instanceof Uint8Array ? e = d.length ? new Qc(new Uint8Array(d)) : Pc || (Pc = new Qc(null)) : (Array.isArray(d) && (e ? Xc(d) : Uc(d) && f.Ya && (d = d.slice())), e = d), C(b, c, e)
    };
    ...
    H.prototype.mb = function(a) {
        ...
        if (Zc(this)) {
            ...
            var b = Zc(this);
            if (b && !a.Ya) throw Error("copyRepeatedFields must be true for frozen messages");
            var c = new this.constructor;
            this.ya && (c.ya = this.ya.slice());
            for (var d = this.G, e = 0; e < d.length; e++) {
                var f = d[e];
                if (e === d.length - 1 && $c(f))
                    for (h in f) {
                        var g = +h;
                        Number.isNaN(g) ? sd(c)[h] = f[h] : Id(this, c, g, f[h], b, a)
                    } else Id(this, c, e - this.ja, f, b, a)
            }
            var h = c
        } else h = this;
        return h
    ...
    if (dd) {
        var Jd = {};
        Object.defineProperties(H, (Jd[Symbol.hasInstance] = hd(Object[Symbol.hasInstance]), Jd))
    };
    ...
    function Ld(a) {
        ...
        var c = new Kd;
        this.l = c.promise;
        this.m = q((0, y[a].a)(b, function(d, e) {
    ...
    Ld.prototype.snapshot = function(a) {
    ...
    */
    ...
    l.equals = function(a) {
        return a instanceof Od && (this == a ? !0 : this && a ? this.x == a.x && this.y == a.y : !1)
    };
    l.ceil = function() {
    ...
    l = Pd.prototype;
    l.clone = function() {
        return new Pd(this.width, this.height)
    };
    ...
    var Ud = {
            Sc: "allow-forms",
            Tc: "allow-modals",
            Uc: "allow-orientation-lock",
            Vc: "allow-pointer-lock",
            Wc: "allow-popups",
            Xc: "allow-popups-to-escape-sandbox",
            Yc: "allow-presentation",
            Zc: "allow-same-origin",
            bd: "allow-scripts",
    ...
    var ae = [$d("data"), $d("http"), $d("https"), $d("mailto"), $d("ftp"), new Zd(function(a) {
        return /^[^:]*([/?#]|$)/.test(a)
    })];
    ...
    var ee = "client_dev_mss_url client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");
    fa(ee);
    ...
    function fe() {
        ...
        function b(t) {
            for (var x = g, v = 0; 64 > v; v += 4) x[v / 4] = t[v] << 24 | t[v + 1] << 16 | t[v + 2] << 8 | t[v + 3];
            for (v = 16; 80 > v; v++) t = x[v - 3] ^ x[v - 8] ^ x[v - 14] ^ x[v - 16], x[v] = (t << 1 | t >>> 31) & 4294967295;
            t = e[0];
            var D = e[1],
                G = e[2],
                K = e[3],
            ...
            for (v = 0; 80 > v; v++) {
                if (40 > v)
                    if (20 > v) {
                        var O = K ^ D & (G ^ K);
                        var S = 1518500249
                    } else O = D ^ G ^ K, S = 1859775393;
                else 60 > v ? (O = D & G | K & (D | G), S = 2400959708) : (O = D ^ G ^ K, S = 3395469782);
                O = ((t << 5 | t >>> 27) & 4294967295) + O + N + S + x[v] & 4294967295;
                N = K;
                K = G;
        ...
        function c(t, x) {
            if ("string" === typeof t) {
                ...
                for (var v = [], D = 0, G = t.length; D < G; ++D) v.push(t.charCodeAt(D));
                t = v
            }
            x || (x = t.length);
            v = 0;
            if (0 == m)
                for (; v + 64 < x;) b(t.slice(v, v + 64)), v += 64, p += 64;
            for (; v < x;)
                if (f[m++] = t[v++], p++, 64 == m)
                    for (m = 0, b(f); v + 64 < x;) b(t.slice(v, v + 64)), v += 64, p += 64
        }
        ...
        function d() {
            ...
            for (var v = 63; 56 <= v; v--) f[v] = x & 255, x >>>= 8;
            b(f);
            for (v = x = 0; 5 > v; v++)
                for (var D = 24; 0 <= D; D -= 8) t[x++] = e[v] >> D & 255;
            return t
        }
        ...
        return {
            ...
            digest: d,
            Vb: function() {
                for (var t = d(), x = "", v = 0; v < t.length; v++) x += "0123456789ABCDEF".charAt(Math.floor(t[v] / 16)) + "0123456789ABCDEF".charAt(t[v] % 16);
                return x
            }
        }
    };
    ...
    function ge(a, b, c) {
        ...
        return d && a && b ? [b, he(de(d), a, c || null)].join(" ") : null
    }
    ...
    var pe = new ne("undefined" == typeof document ? null : document);
    ...
    function re(a) {
        ...
        qe(a) && (b = b || y.__1PSAPISID);
        if (b) return !0;
        var c = new ne(document);
        b = c.get("SAPISID") || c.get("APISID") || c.get("__Secure-3PAPISID") || c.get("SID");
        qe(a) && (b = b || c.get("__Secure-1PAPISID"));
        return !!b
    }

    function se(a, b, c, d) {
        (a = y[a]) || (a = (new ne(document)).get(b));
        return a ? ge(a, c, d) : null
    }

    function te(a) {
        var b = void 0 === b ? !1 : b;
        var c = de(String(y.location.href)),
            d = [];
        if (re(b)) {
            c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:");
            var e = c ? y.__SAPISID : y.__APISID;
            e || (e = new ne(document), e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID"));
            (e = e ? ge(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e);
            c && qe(b) && ((b = se("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = se("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a))
        }
        return 0 ==
    ...
    Je.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Ke(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Ka = !1)) : (b = new He(b, this.src, f, !!d, e), b.Ka = c, a.push(b));
        return b
    };
    ...
    function Le(a, b) {
        var c = b.type;
        c in a.listeners && ib(a.listeners[c], b) && (Ie(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }

    function Ke(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.Aa && f.listener == b && f.capture == !!c && f.Oa == d) return e
        }
        return -1
    };
    ...
    function Pe(a, b, c, d, e) {
        ...
        else c = Re(c), a && a[Fe] ? a.U(b, c, Oa(d) ? !!d.capture : !!d, e) : Se(a, b, c, !1, d, e)
    }
    ...
    function Qe(a, b, c, d, e) {
        ...
        else c = Re(c), a && a[Fe] ? a.m.add(String(b), c, !0, Oa(d) ? !!d.capture : !!d, e) : Se(a, b, c, !0, d, e)
    }

    function Xe(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Xe(a, b[f], c, d, e);
        else(d = Oa(d) ? !!d.capture : !!d, c = Re(c), a && a[Fe]) ? a.m.remove(String(b), c, d, e) : a && (a = Te(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Ke(b, c, d, e)), (c = -1 < a ? b[a] : null) && Ye(c))
    }
    ...
    function af(a, b) {
        ...
        a = a.W;
        c = b.type || b;
        "string" === typeof b ? b = new xe(b, a) : b instanceof xe ? b.target = b.target || a : (e = b, b = new xe(c, a), wb(b, e));
        e = !0;
        if (d)
    ...
    $e.prototype.U = function(a, b, c, d) {
    ...
    function ef(a) {
        a.A = a.T.M(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return a.j ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.u(3) : u(c, df(a), 3) : u(c, df(a), 3);
                ef(a);
                c.i = 0
            })
        }, 3E4)
    ...
    function df(a, b) {
        return a.v ? a.v : a.v = new Promise(function(c) {
            ...
            return w(function(h) {
                switch (h.i) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, wa(h, 2, 3), d && (a.l = a.T.M(function() {
                            d.abort()
                        }, b || 2E4)), u(h, fetch("/generate_204", {
                            method: "HEAD",
                            signal: f
                        }), 5);
                    case 5:
    ...
    var hf = {
            Xg: "EMBEDDED_PLAYER_MODE_UNKNOWN",
            Ug: "EMBEDDED_PLAYER_MODE_DEFAULT",
            Wg: "EMBEDDED_PLAYER_MODE_PFP",
            Vg: "EMBEDDED_PLAYER_MODE_PFL"
        },
        jf = {
            Wo: "WEB_DISPLAY_MODE_UNKNOWN",
            So: "WEB_DISPLAY_MODE_BROWSER",
            Uo: "WEB_DISPLAY_MODE_MINIMAL_UI",
            Vo: "WEB_DISPLAY_MODE_STANDALONE",
            To: "WEB_DISPLAY_MODE_FULLSCREEN"
        };
    ...
    function lf(a) {
        -1 === a.i && (a.i = gb(a.data_, function(b, c, d) {
    ...
    function Gf(a, b) {
        a.classList ? b = a.classList.contains(b) : (a = a.classList ? a.classList : Ef(a).match(/\S+/g) || [], b = 0 <= cb(a, b));
        return b
    }

    function Hf() {
        var a = document.body;
        a.classList ? a.classList.remove("inverted-hdpi") : Gf(a, "inverted-hdpi") && Ff(a, Array.prototype.filter.call(a.classList ? a.classList : Ef(a).match(/\S+/g) || [], function(b) {
    ...
    function Lf(a) {
        ...
        if ("function" == typeof a.X) return new Mf(function() {
            return a.X()
        });
    ...
    Mf.prototype.X = function() {
        return new Nf(this.j())
    };
    Mf.prototype[Symbol.iterator] = function() {
        return new Of(this.j())
    };
    ...
    l.clear = function() {
        this.j = {};
        this.ha = this.size = this.i.length = 0
    };
    l.remove = function(a) {
        return this.delete(a)
    };
    l.delete = function(a) {
        return Rf(this.j, a) ? (delete this.j[a], --this.size, this.ha++, this.i.length > 2 * this.size && Qf(this), !0) : !1
    };
    ...
    function Qf(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], Rf(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    l.get = function(a, b) {
    ...
    l.set = function(a, b) {
        Rf(this.j, a) || (this.size += 1, this.i.push(a), this.ha++);
        this.j[a] = b
    };
    ...
    l.keys = function() {
        return Lf(this.X(!0)).i()
    };
    l.values = function() {
        return Lf(this.X(!1)).i()
    };
    l.entries = function() {
        var a = this;
        ...
        if (null == b) c.push("null");
            ...
            if ("object" == typeof b) {
                if (Array.isArray(b)) {
                    ...
                    b = d.length;
                    c.push("[");
                    for (var e = "", f = 0; f < b; f++) c.push(e), Uf(a, d[f], c), e = ",";
                    c.push("]");
                    return
                }
                if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                    ...
                    c.push("{");
                    e = "";
                    for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), Wf(d, c), c.push(":"), Uf(a, f, c), e = ","));
                    c.push("}");
                    return
                }
            }
    ...
    function Wf(a, b) {
        b.push('"', a.replace(Yf, function(c) {
            var d = Xf[c];
            d || (d = "\\u" + (c.charCodeAt(0) | 65536).toString(16).slice(1), Xf[c] = d);
            return d
        }), '"')
    };
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? jg(c, b) : (f ? (d = f, d.next == c.m && (c.m = d), d.next = d.next.next) : kg(c), lg(c, e, 3, b)))
                }
                a.l = null
            } else $f(a, 3, b)
    }
    ...
    function $f(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.D = c, a.i = b, a.l = null, ng(a), 3 != b || c instanceof gg || pg(a, c))
        }
    }
    ...
    Zf.prototype.v = function() {
        for (var a; a = kg(this);) lg(this, a, this.i, this.D);
        this.o = !1
    };
    ...
    function lg(a, b, c, d) {
        ...
        if (b.i) b.i.l = null, qg(b, c, d);
        else try {
            b.l ? b.j.call(b.context) : qg(b, c, d)
        } catch (e) {
            rg.call(null, e)
        }
        nf(bg, b)
    ...
    l.va = function(a) {
        ...
        if (b) {
            var c = this.l[b];
            0 != this.o ? (this.m.push(a), this.j[a + 1] = function() {}) : (c && ib(c, a), delete this.j[a], delete this.j[a + 1], delete this.j[a + 2])
        }
        return !!b
    };
    l.ia = function(a, b) {
    ...
    l.clear = function(a) {
        if (a) {
            var b = this.l[a];
            b && (b.forEach(this.va, this), delete this.l[a])
    ...
    ug.prototype.set = function(a, b) {
        void 0 === b ? this.i.remove(a) : this.i.set(a, Tf(b))
    };
    ...
    vg.prototype.set = function(a, b) {
        vg.Y.set.call(this, a, xg(b))
    };
    vg.prototype.j = function(a) {
        a = vg.Y.get.call(this, a);
    ...
    yg.prototype.set = function(a, b, c) {
        ...
        yg.Y.set.call(this, a, b)
    };
    yg.prototype.j = function(a) {
        var b = yg.Y.j.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
    ...
    function Dg(a, b) {
        ...
        if (c) {
            Eg || (Eg = new Pf);
            this.i = Eg.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), Eg.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    l.set = function(a, b) {
        this.i.setAttribute(Gg(a), b);
        Hg(this)
    };
    l.get = function(a) {
        a = this.i.getAttribute(Gg(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    l.remove = function(a) {
        this.i.removeAttribute(Gg(a));
        Hg(this)
    };
    l.X = function(a) {
        var b = 0,
    ...
    Ig.prototype.X = function(a) {
        ...
        d.next = function() {
            ...
            return Kf(a ? e.slice(c.i.length) : c.j.get(e))
        };
        return d
    };
    ...
    r(Kg, H);
    Kg.prototype.getKey = function() {
        return td(this, 1)
    };
    Kg.prototype.getValue = function() {
        return td(this, 2 === wd(this, Lg) ? 2 : -1)
    };
    Kg.prototype.setValue = function(a) {
        return vd(this, 2, Lg, a)
    };
    var Lg = [2, 3, 4, 5, 6];
    ...
    r(Qg, H);
    Qg.prototype.getPlayerType = function() {
        return td(this, 36)
    };
    Qg.prototype.setHomeGroupInfo = function(a) {
        return E(this, Og, 81, a)
    };
    var Rg = [9, 66, 24, 32, 86, 100, 101];
    ...
    r(Ug, H);
    Ug.prototype.setToken = function(a) {
        return C(this, 2, a)
    };
    ...
    r(Vg, H);
    Vg.prototype.setSafetyMode = function(a) {
        return C(this, 5, a)
    };
    var Wg = [12];
    ...
    ah.prototype.setValue = function(a) {
        return C(this, 2, a)
    };
    var $g = [4, 5];
    ...
    r(eh, H);
    eh.prototype.getMessage = function() {
        return Bd(this, 1)
    };
    ...
    r(oh, H);
    oh.prototype.getVideoData = function() {
        return xd(this, nh, 15)
    };
    var ph = [4];
    ...
    Dh.prototype.getPlayerType = function() {
        var a = td(this, 7);
        return null == a ? 0 : a
    };
    Dh.prototype.setVideoId = function(a) {
        return C(this, 19, a)
    };
    ...
    r(Qh, H);
    Qh.prototype.setVideoId = function(a) {
        return vd(this, 1, Rh, a)
    };
    Qh.prototype.getPlaylistId = function() {
        return td(this, 2 === wd(this, Rh) ? 2 : -1)
    };
    var Rh = [1, 2];
    ...
    var Vh = y.window,
        Wh, Xh, Yh = (null == Vh ? void 0 : null == (Wh = Vh.yt) ? void 0 : Wh.config_) || (null == Vh ? void 0 : null == (Xh = Vh.ytcfg) ? void 0 : Xh.data_) || {};
    z("yt.config_", Yh);
    ...
    function L(a, b) {
        return a in Yh ? Yh[a] : b
    }

    function $h() {
        var a = Yh.EXPERIMENT_FLAGS;
    ...
    function hi(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = L("ERRORS", []), e.push([a, "ERROR", b, c, d]), Zh("ERRORS", e));
        fi(a)
    }

    function ii(a, b, c, d) {
        var e = A("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = L("ERRORS", []), e.push([a, "WARNING", b, c, d]), Zh("ERRORS", e))
    };
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                ...
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: qi == p ? "unchanged" : p
                }];
                ni.hasOwnProperty(m) || ii(k)
            }
        }
        return c
    }
    ...
    function ti(a) {
        return -1 != a.indexOf("?") ? (a = (a || "").split("#")[0], a = a.split("?", 2), si(1 < a.length ? a[1] : a[0])) : {}
    }
    ...
    function pi(a) {
        return a && a.match(mi) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function wi(a) {
        ...
        try {
            ...
            e.u_his = h;
            var k;
            e.u_h = null == (k = Md.screen) ? void 0 : k.height;
            var m;
            e.u_w = null == (m = Md.screen) ? void 0 : m.width;
            var p;
            e.u_ah = null == (p = Md.screen) ? void 0 : p.availHeight;
            var t;
            e.u_aw =
                null == (t = Md.screen) ? void 0 : t.availWidth;
            var x;
            e.u_cd = null == (x = Md.screen) ? void 0 : x.colorDepth
        } catch (ua) {}
        h = b.i;
        try {
            var v = h.screenX;
        ...
        v = [S, ka, v, D, V, W, G, K, N, O];
        try {
            var Pa = (b.i.top || window).document,
                va = "CSS1Compat" ==
                Pa.compatMode ? Pa.documentElement : Pa.body;
            var F = (new Pd(va.clientWidth, va.clientHeight)).round()
        } catch (ua) {
            F = new Pd(-12245933, -12245933)
        }
        Pa = F;
        F = {};
        var Ca = void 0 === Ca ? y : Ca;
        va = new kf;
        Ca.SVGElement && Ca.document.createElementNS && va.set(0);
        D = Xd();
        D["allow-top-navigation-by-user-activation"] && va.set(1);
        D["allow-popups-to-escape-sandbox"] && va.set(2);
        ...
        b = (F.vis =
            b.prerendering ? 3 : {
                ...
                preview: 4,
                unloaded: 5
            } [b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, F.wgl = !!Md.WebGLRenderingContext, F);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var yi = "XMLHttpRequest" in y ? function() {
    ...
    var Di = {
        ...
        Ei = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(fa(ee)),
        Fi = !1;
    ...
    function Gi(a, b) {
        ...
        if (c || !cc(a)) b["X-YouTube-Ad-Signals"] = ri(wi());
        return b
    }
    ...
    function Hi(a) {
        var b = window.location.search,
            c = cc(a);
        M("debug_handle_relative_url_for_query_forward_killswitch") || c || !vi(a) || (c = document.location.hostname);
        var d = ac(bc(5, a));
    ...
    function Ii(a, b) {
        ...
        var d = Ki(a, b),
            ...
            f = Li(a, function(k) {
                    if (!e) {
                        ...
                        if (m || t || x) p = Mi(a, c, k, b.convertToSafeHtml);
                        ...
                        t = b.context || y;
                        m ? b.onSuccess && b.onSuccess.call(t, k, p) : b.onError && b.onError.call(t, k, p);
                        b.onFinish && b.onFinish.call(t, k, p)
                    }
                }, b.method,
        ...
        if (b.onTimeout && 0 < d) {
            var g = b.onTimeout;
            var h = Bi(function() {
                e || (e = !0, f.abort(), Ci(h), g.call(b.context || y, f))
            }, d)
        }
        return f
    }
    ...
    function Ji(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = ui(a, b || {}, !0);
        return a
    }
    ...
    function Ki(a, b) {
        ...
        f && "string" === typeof e && (e = si(e), wb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : fc(e));
        f = e || f && !nb(f);
        !Fi && f && "POST" != b.method && (Fi = !0, hi(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, ii(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? Ni(a) : null) e = {}, db(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = Oi(g)
                })
        }
        d && Pi(e);
    ...
    function Pi(a) {
        if (Oa(a))
            for (var b in a) {
                ...
                if (c) {
                    c = b;
                    Bb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");
                    var d = a[b],
                        e = yb();
    ...
    function Li(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && gi(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = zi();
        ...
        M("debug_forward_web_query_parameters") && (a = Hi(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function Ti(a) {
        return pe.get("" + a, void 0)
    }

    function Ui() {
        if (!pe.isEnabled()) return !1;
        if (!pe.isEmpty()) return !0;
        pe.set("TESTCOOKIESENABLED", "1", {
            Qa: 60
        });
        if ("1" !== pe.get("TESTCOOKIESENABLED")) return !1;
        pe.remove("TESTCOOKIESENABLED");
        return !0
    };
    var Vi = A("ytglobal.prefsUserPrefsPrefs_") || {};
    z("ytglobal.prefsUserPrefsPrefs_", Vi);
    ...
    function Wi() {
        ...
        if (a) {
            ...
            for (var b = 0; b < a.length; b++) {
                var c = a[b].split("="),
                    d = c[0];
                (c = c[1]) && (Vi[d] = c.toString())
            }
        }
    }
    Wi.prototype.get = function(a, b) {
        Xi(a);
        Yi(a);
        a = void 0 !== Vi[a] ? Vi[a].toString() : null;
        return null != a ? a : b ? b : ""
    };
    ...
    function Zi(a) {
        return !!(($i("f" + (Math.floor(a / 31) + 1)) || 0) & 1 << a % 31)
    }
    ...
    function Aj() {
        var a = zj();
        if (a) {
            var b = aj[a.type || "unknown"] || "CONN_UNKNOWN";
            a = aj[a.effectiveType || "unknown"] || "CONN_UNKNOWN";
    ...
    function Bj() {
        var a = zj();
        if (null != a && a.effectiveType) return yj.hasOwnProperty(a.effectiveType) ? yj[a.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN"
    };

    function Cj() {
        return "INNERTUBE_API_KEY" in Yh && "INNERTUBE_API_VERSION" in Yh
    }
    ...
    function Dj() {
        return {
            ...
            eb: L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            zb: L("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            Zb: L("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            innertubeContextClientVersion: L("INNERTUBE_CONTEXT_CLIENT_VERSION"),
            Bb: L("INNERTUBE_CONTEXT_HL"),
            Ab: L("INNERTUBE_CONTEXT_GL"),
            ac: L("INNERTUBE_HOST_OVERRIDE") || "",
            dc: !!L("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            cc: !!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
                !1),
    ...
    function Ej(a) {
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = q(Object.entries(si(L("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = q(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function Jj(a) {
        ...
        if (a.eb) {
            ...
            E(c, Mg, 62, e)
        }(d = y.devicePixelRatio) && 1 != d && C(c, 65, d);
        d = ci();
        "" !== d && C(c, 54, d);
        d = di();
        if (0 < d.length) {
        ...
        Hj(a, c);
        Ij(c);
        L("DELEGATED_SESSION_ID") && !M("pageid_as_header_web") && (a = new Vg, C(a, 3, L("DELEGATED_SESSION_ID")));
        a = q(Object.entries(si(L("DEVICE", ""))));
    ...
    function Ij(a, b) {
        var c = Aj();
        c && (a ? C(a, 61, wj[c]) : b && (b.client.connectionType = c));
        M("web_log_effective_connection_type") && (c = Bj()) && (a ? C(a, 94, xj[c]) : b && (b.client.effectiveConnectionType = c))
    }
    ...
    function Kj(a, b, c) {
        ...
        (b = c.mp || L("AUTHORIZATION")) || (a ? b = "Bearer " + A("gapi.auth.getToken")().lp : b = te([]));
    ...
    Mj.prototype.get = function(a, b) {
        ...
        if (d && (c = Ti(a)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    var Nj = window,
        P = Nj.ytcsi && Nj.ytcsi.now ? Nj.ytcsi.now : Nj.performance && Nj.performance.timing && Nj.performance.now && Nj.performance.timing.navigationStart ? function() {
            return Nj.performance.timing.navigationStart + Nj.performance.now()
        } : function() {
    ...
    function Qj(a, b, c, d) {
        ...
        Pj().set("nextId", d + 1, 86400, !0);
        Pj().set("requests", e, 86400, !0);
        return d
    }

    function Rj(a) {
        var b = Pj().get("requests", !0) || {};
        delete b[a];
        Pj().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(P()) - d.requestTime)) {
                    var e = d.authState,
                        f = Lj(Kj(!1));
                    qb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(P())), Tj(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Pj().set("requests", b, 86400, !0)
    ...
    function Wj(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Bi(a, c || 0)
    }
    Zj.prototype.S = function(a) {
        if (void 0 === a || !Number.isNaN(Number(a))) {
            var b = A("yt.scheduler.instance.cancelJob");
            b ? b(a) : Ci(a)
        }
    };
    Zj.prototype.start = function() {
        var a = A("yt.scheduler.instance.start");
        a && a()
    };
    Zj.prototype.pause = function() {
    ...
    function ik() {
        var a = {};
        for (gk = new jk(void 0 === a.handleError ? kk : a.handleError, void 0 === a.logEvent ? lk : a.logEvent); 0 < fk.length;) switch (a = fk.shift(), a.type) {
            case "ERROR":
                gk.handleError(a.payload);
                break;
            case "EVENT":
                gk.logEvent(a.eventType, a.payload)
        }
    }

    function mk(a) {
        hk || (gk ? gk.handleError(a) : (fk.push({
            type: "ERROR",
            payload: a
    ...
    function zk(a, b) {
        yk.call(this, "MISSING_OBJECT_STORES", {
    ...
    r(Ak, Error);
    var Bk = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];

    function Ck(a, b, c, d) {
        b = rk(b);
        var e = a instanceof Error ? a : Error("Unexpected error: " + a);
        if (e instanceof yk) return e;
        a = {
            objectStoreNames: c,
            dbName: b,
            dbVersion: d
        };
        if ("QuotaExceededError" === e.name) return new yk("QUOTA_EXCEEDED", a);
        if (Jc && "UnknownError" === e.name) return new yk("QUOTA_MAYBE_EXCEEDED", a);
        if (e instanceof Ak) return new yk("MISSING_INDEX", Object.assign({}, a, {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && Bk.some(function(f) {
                return e.message.includes(f)
            })) return new yk("EXECUTE_TRANSACTION_ON_CLOSED_DB",
            a);
        if ("AbortError" === e.name) return new yk("UNKNOWN_ABORT", a, e.message);
    ...
    function Dk(a, b, c) {
        var d = ek();
        return new yk("IDB_NOT_SUPPORTED", {
            context: {
                caller: a,
                publicName: b,
                version: c,
    ...
    Hk.all = function(a) {
        return new Hk(new Gk(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    na: f.na
                }, ++f.na) Ik(Hk.resolve(a[f.na]).then(function(g) {
                return function(h) {
                    d[g.na] = h;
                    e--;
                    0 === e && b(d)
    ...
    Hk.resolve = function(a) {
        return new Hk(new Gk(function(b, c) {
            a instanceof Hk ? a.then(b, c) : b(a)
        }))
    };
    Hk.reject = function(a) {
        return new Hk(new Gk(function(b, c) {
            c(a)
        }))
    };
    Hk.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : Fk,
            e = null != b ? b : Ek;
        return new Hk(new Gk(function(f, g) {
            "PENDING" === c.state.status ? (c.i.push(function() {
                Jk(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Kk(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Jk(c, c, d, f, g) : "REJECTED" === c.state.status && Kk(c, c, e, f, g)
        }))
    };
    ...
    function Jk(a, b, c, d, e) {
        try {
            ...
            f instanceof Hk ? Lk(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function Pk(a, b) {
        return new Hk(new Gk(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
    ...
    function Uk(a, b) {
        return Rk(a, ["LogsRequestsStore"], {
            mode: "readwrite",
            O: !0
        }, function(c) {
            c = c.objectStore("LogsRequestsStore");
            return Ok(c.i.put(b, void 0))
        })
    }
        ...
        return w(function(K) {
            switch (K.i) {
                ...
                case 2:
                    ...
                    return u(K, N, 6);
                case 6:
                    return p = K.j, t = Math.round(P()), Xk(a, k, t, g, void 0, b.join(), e), K.return(p);
                case 4:
                    x = ya(K);
                    v = Math.round(P());
                    D = Ck(x, a.i.name, b.join(), a.i.version);
                    if ((G = D instanceof yk && !D.i) || g >= f) Xk(a, k, v, g, D, b.join(), e), h = D;
                    K.u(2);
                    break;
                case 3:
    ...
    function Xk(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof yk && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && nk("QUOTA_EXCEEDED", {
            dbName: rk(a.i.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof yk && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), nk("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.j = !0), Yk(a, !1, d, f, b, g.tag), mk(e)) : Yk(a, !0, d, f, b, g.tag)
    }

    function Yk(a, b, c, d, e, f) {
        nk("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    l = Tk.prototype;
    l.add = function(a, b) {
        return Ok(this.i.add(a, b))
    };
    l.autoIncrement = function() {
        return this.i.autoIncrement
    };
    l.clear = function() {
        return Ok(this.i.clear()).then(function() {})
    };
    l.count = function(a) {
        return Ok(this.i.count(a))
    };
    ...
    l.delete = function(a) {
        return a instanceof IDBKeyRange ? Zk(this, a) : Ok(this.i.delete(a))
    };
    l.get = function(a) {
        return Ok(this.i.get(a))
    };
    l.index = function(a) {
        try {
            return new al(this.i.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new Ak(a, this.i.name);
            throw b;
        }
    };
    l.getName = function() {
    ...
    function bl(a) {
        return Ok(a).then(function(b) {
            return b ? new dl(a, b) : null
        })
    }
    l = dl.prototype;
    l.advance = function(a) {
        this.cursor.advance(a);
        return bl(this.request)
    };
    ...
    l.delete = function() {
        return Ok(this.cursor.delete()).then(function() {})
    };
    l.getKey = function() {
    ...
    l.update = function(a) {
        return Ok(this.cursor.update(a))
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(v) {
                try {
                    ...
                    v.dataLoss && "none" !== v.dataLoss && nk("IDB_DATA_CORRUPTED", {
                        reason: v.dataLossMessage || "unknown reason",
                        dbName: rk(a)
                    });
                    var D = f(),
                        G = new Vk(g.transaction);
                    p && p(D, function(K) {
                        return v.oldVersion < K && v.newVersion >= K
                    }, G);
                    G.done.catch(function(K) {
                        e(K)
                    })
                } catch (K) {
                    e(K)
    ...
    il.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return gl(this.name, a)
    };

    function jl(a, b) {
        return new yk("INCOMPATIBLE_DB_VERSION", {
            dbName: a.name,
    ...
    function kl(a, b) {
        if (!b) throw Dk("openWithToken", rk(a.name));
        return ll(a)
    }

    function ll(a) {
        function b() {
            var f, g, h, k, m, p, t, x, v, D;
            return w(function(G) {
                switch (G.i) {
                    case 1:
                        return g = null != (f = Error().stack) ? f : "", wa(G, 2), u(G, a.l(a.name, a.options.version, d), 4);
                    case 4:
                        h = G.j;
                        for (var K = a.options, N = [], O = q(Object.keys(K.za)), S = O.next(); !S.done; S = O.next()) {
                            S = S.value;
                            var ka = K.za[S],
                                V = void 0 === ka.mc ? Number.MAX_VALUE : ka.mc;
                            !(h.i.version >= ka.Xa) || h.i.version >= V || h.i.objectStoreNames.contains(S) || N.push(S)
                        }
                        k = N;
                        if (0 === k.length) {
                            G.u(5);
                        ...
                        m = Object.keys(a.options.za);
                        p = h.objectStoreNames();
                        if (a.o < bi("ytidb_reopen_db_retries", 0)) return a.o++, h.close(), mk(new yk("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: m,
                            foundObjectStores: p
                        })), G.return(b());
                        if (!(a.s < bi("ytidb_remake_db_retries", 1))) {
                            G.u(6);
                            break
                        }
                        a.s++;
                    ...
                    case 8:
                        a.j *= 2;
                    case 7:
                        return u(G, a.delete(), 9);
                    case 9:
                        return mk(new yk("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: m,
                            foundObjectStores: p
                        })), G.return(b());
                    ...
                    case 2:
                        ...
                        return u(G, a.l(a.name, void 0, Object.assign({}, d, {
                            upgrade: void 0
                        })), 11);
                    case 11:
                        x = G.j;
                        v = x.i.version;
                        if (void 0 !== a.options.version && v > a.options.version + 1) throw x.close(),
                            a.m = !1, jl(a, v);
                        return G.return(x);
                    case 10:
        ...
        return w(function(d) {
            ...
            return d.return(Rk(c, ["databases"], {
                ...
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1) return Ok(f.i.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    ...
    function ol(a, b) {
        var c;
        return w(function(d) {
            if (1 == d.i) return a ? u(d, kl(ml, b), 2) : d.return();
            c = d.j;
    ...
    function pl(a, b) {
        var c, d;
        return w(function(e) {
            return 1 == e.i ? (c = [], u(e, kl(ml, b), 2)) : 3 != e.i ? (d = e.j, u(e, Rk(d, ["databases"], {
                O: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return $k(f.objectStore("databases"), {}, function(g) {
    ...
    function sl(a) {
        var b, c;
        return w(function(d) {
            if (1 == d.i) return b = pk("YtIdbMeta hasAnyMeta other"), u(d, pl(function(e) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = bk) f = /WebKit\/([0-9]+)/.exec(Ob()), f = !!(f && 600 <= parseInt(f[1], 10));
                    ...
                    return u(e, nl(d, ul), 4);
                case 4:
                    return u(e, ol("yt-idb-test-do-not-use", ul), 5);
                case 5:
                    return e.return(!0);
                case 2:
    ...
    function yl() {
        var a = xl();
        return a ? Promise.resolve(a) : wl().then(function(b) {
            (b = b ? ul : void 0) && z("ytglobal.idbToken_", b);
            return b
        })
    };
    var zl = 0;
            ...
            return w(function(h) {
                switch (h.i) {
                    ...
                    case 5:
                        ...
                        f = e[0];
                        return u(h, gl(f.actualName), 7);
                    case 7:
                        return u(h, ol(f.actualName, c), 6);
                    case 6:
                        xa(h, 4);
                        break;
                    case 3:
    ...
    function Bl() {
        var a;
        return w(function(b) {
            return 1 == b.i ? u(b, yl(), 2) : (a = b.j) ? b.return(sl(a)) : b.return(!1)
        })
    }
    new Kd;

    function Cl(a) {
        if (!ok()) throw a = new yk("AUTH_INVALID", {
            dbName: a
        }), mk(a), a;
        var b = pk();
        return {
    ...
    function Dl(a, b, c, d) {
        ...
        return w(function(p) {
            switch (p.i) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", u(p, yl(), 2);
                case 2:
                    g = p.j;
                    if (!g) throw h = Dk("openDbImpl", a, b), M("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), mk(h), h;
                    qk(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                    ...
                    return u(p, nl(k, g), 5);
                case 5:
                    return u(p, fl(k.actualName, b, d), 6);
                case 6:
                    return p.return(p.j);
                case 3:
                    return m = ya(p), wa(p, 7), u(p, ol(k.actualName, g), 9);
                case 9:
                    xa(p,
                        8);
                    break;
    ...
    function Gl(a, b) {
        ...
        var c, d;
        return w(function(e) {
            if (1 == e.i) return u(e, yl(), 2);
            if (3 != e.i) {
                c = e.j;
                if (!c) return e.return();
                qk(a);
                d = Cl(a);
                return u(e, gl(d.actualName, b), 3)
            }
            return u(e, ol(d.actualName, c), 0)
        })
    }
    ...
    function Hl(a, b, c) {
        a = a.map(function(d) {
            return w(function(e) {
                return 1 == e.i ? u(e, gl(d.actualName, b), 2) : u(e, ol(d.actualName, c), 0)
            })
        });
    ...
    function Kl(a) {
        ...
        this.xa = !1;
        var b;
        this.Mb = null != (b = a.Mb) ? b : 100;
        var c;
        this.Kb = null != (c = a.Kb) ? c : 1;
        var d;
        this.Ib = null != (d = a.Ib) ? d : 2592E6;
        var e;
        this.Gb = null != (e = a.Gb) ? e : 12E4;
        var f;
        this.Jb = null != (f = a.Jb) ? f : 5E3;
        var g;
        this.C = null != (g = a.C) ? g : void 0;
        this.Na = !!a.Na;
        var h;
        this.Ma = null != (h = a.Ma) ? h : .1;
        var k;
        this.Sa = null != (k = a.Sa) ? k : 10;
        ...
        this.jb =
            a.jb;
        this.ib = a.ib;
        Ll(this) && (!this.F || this.F("networkless_logging")) && Ml(this)
    }

    function Ml(a) {
        Ll(a) && !a.xa && (a.i = !0, a.Na && Math.random() <= a.Ma && a.K.Tb(a.C), Nl(a), a.J.H() && a.Ca(), a.J.U(a.jb, a.Ca.bind(a)), a.J.U(a.ib, a.pb.bind(a)))
    }
    l = Kl.prototype;
    l.writeThenSend = function(a, b) {
        ...
        if (Ll(this) && this.i) {
            ...
            this.K.set(d, this.C).then(function(e) {
                d.id = e;
                c.J.H() && Ol(c, d)
            }).catch(function(e) {
                Ol(c, d);
    ...
    l.sendThenWrite = function(a, b, c) {
        ...
        if (Ll(this) && this.i) {
            ...
            if (this.J.H() || this.F && this.F("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    ...
                    b.onError = function(g, h) {
                        return w(function(k) {
                            if (1 == k.i) return u(k, d.K.set(e, d.C).catch(function(m) {
                                Pl(d, m)
                            }), 2);
                            f(g, h);
                            k.i = 0
            ...
            } else this.K.set(e, this.C).catch(function(g) {
    ...
    l.sendAndWrite = function(a, b) {
        ...
        if (Ll(this) && this.i) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.K.qa(d.id, c.C) : e = !0;
                c.J.aa && c.F && c.F("vss_network_hint") && c.J.aa(!0);
                f(g, h)
            };
            this.ba(d.url, d.options);
            this.K.set(d, this.C).then(function(g) {
                d.id = g;
                e && c.K.qa(d.id, c.C)
            }).catch(function(g) {
                Pl(c, g)
    ...
    l.Ca = function() {
        var a = this;
        if (!Ll(this)) throw Dk("throttleSend");
        this.j || (this.j = this.T.M(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return u(c, a.K.yb("NEW", a.C), 2);
                if (3 != c.i) return b = c.j, b ? u(c, Ol(a, b), 3) : (a.pb(), c.return());
                a.j && (a.j = 0, a.Ca());
                c.i = 0
            })
        }, this.Mb))
    ...
    function Ol(a, b) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    if (!Ll(a)) throw c = Dk("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.u(2);
                        break
                    }
                    return u(e, a.K.ec(b.id, a.C), 3);
                case 3:
                    (d = e.j) ? b = d: a.ra(Error("The request cannot be found in the database."));
                case 2:
                    if (Ql(a, b, a.Ib)) {
                        e.u(4);
                        break
                    ...
                    return u(e, a.K.qa(b.id, a.C), 5);
                case 5:
                    return e.return();
                case 4:
                    b.skipRetry || (b = Rl(a, b));
                    if (!b) {
                        e.u(0);
                        break
                    }
    ...
    function Rl(a, b) {
        if (!Ll(a)) throw Dk("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return w(function(m) {
                switch (m.i) {
                    case 1:
                        g = Sl(f);
                        if (!(a.F && a.F("nwl_consider_error_code") && g || a.F && !a.F("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.Sa)) {
                            m.u(2);
                            break
                        }
                        if (!a.J.ca) {
                    ...
                    case 3:
                        ...
                        return u(m, a.K.kb(b.id, a.C, !1), 6);
                    case 6:
                        return m.return();
                    case 2:
                        if (a.F && a.F("nwl_consider_error_code") &&
                            !g && a.potentialEsfErrorCounter > a.Sa) return m.return();
                        a.potentialEsfErrorCounter++;
                        if (void 0 === (null == (k = b) ? void 0 : k.id)) {
                            m.u(8);
                            break
                        }
                        return b.sendCount < a.Kb ? u(m, a.K.kb(b.id, a.C), 12) : u(m, a.K.qa(b.id, a.C), 8);
                    case 12:
                        a.T.M(function() {
                            a.J.H() && a.Ca()
                        }, a.Jb);
        ...
        b.options.onSuccess = function(e, f) {
            var g;
            return w(function(h) {
                if (1 == h.i) return void 0 === (null == (g = b) ? void 0 : g.id) ? h.u(2) : u(h, a.K.qa(b.id, a.C), 2);
    ...
    function Nl(a) {
        if (!Ll(a)) throw Dk("retryQueuedRequests");
        a.K.yb("QUEUED", a.C).then(function(b) {
            b && !Ql(a, b, a.Gb) ? a.T.M(function() {
                return w(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.u(2) : u(c, a.K.kb(b.id, a.C), 2);
                    Nl(a);
                    c.i = 0
                })
            }) : a.J.H() && a.Ca()
    ...
    function Pl(a, b) {
        a.Ob && !a.J.H() ? a.Ob(b) : a.handleError(b)
    }
    ...
    var Vl = A("ytPubsub2Pubsub2Instance") || new J;
    J.prototype.subscribe = J.prototype.subscribe;
    J.prototype.unsubscribeByKey = J.prototype.va;
    J.prototype.publish = J.prototype.ia;
    J.prototype.clear = J.prototype.clear;
    z("ytPubsub2Pubsub2Instance", Vl);
    var Wl = A("ytPubsub2Pubsub2SubscribedKeys") || {};
    z("ytPubsub2Pubsub2SubscribedKeys", Wl);
    var Xl = A("ytPubsub2Pubsub2TopicToKeys") || {};
    z("ytPubsub2Pubsub2TopicToKeys", Xl);
    var Yl = A("ytPubsub2Pubsub2IsAsync") || {};
    z("ytPubsub2Pubsub2IsAsync", Yl);
    ...
    function am(a) {
        ...
        var d = c.subscribe(b.toString(), function(e, f) {
            ...
            }, Yl[b.toString()] ? A("yt.scheduler.instance") ? gf.M(g) : Bi(g, 0) : g())
        });
        Wl[d] = !0;
        Xl[b.toString()] || (Xl[b.toString()] = []);
        Xl[b.toString()].push(d);
        return d
    }
    ...
    fm.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.lb ? Fl : El)(a, b, Object.assign({}, c))
    };
    fm.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.lb ? Jl : Gl)(this.name, a)
    };
    ...
    function nm(a, b) {
        ...
        return w(function(m) {
            ...
            if (3 != m.i) return d = m.j, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, P()], h = IDBKeyRange.bound(f, g), k = void 0, u(m, Rk(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                O: !0
            }, function(p) {
                return cl(p.objectStore("LogsRequestsStore").index("newRequestV2"), {
                    query: h,
                    direction: "prev"
                }, function(t) {
        ...
        return w(function(d) {
            ...
            return d.return(Rk(c, ["LogsRequestsStore"], {
                ...
                return f.get(a).then(function(g) {
                    if (g) return g.status = "QUEUED", Ok(f.i.put(g, void 0)).then(function() {
                        return g
                    })
                })
            }))
    ...
    function pm(a, b, c) {
        ...
        var d;
        return w(function(e) {
            if (1 == e.i) return u(e, km(b), 2);
            d = e.j;
            return e.return(Rk(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                O: !0
            }, function(f) {
                var g = f.objectStore("LogsRequestsStore");
                return g.get(a).then(function(h) {
                    return h ? (h.status = "NEW", c && (h.sendCount += 1), Ok(g.i.put(h, void 0)).then(function() {
                        return h
                    })) : Hk.resolve(void 0)
                })
            }))
    ...
    function rm(a) {
        var b, c;
        return w(function(d) {
            if (1 == d.i) return u(d, km(a), 2);
            b = d.j;
            c = P() - 2592E6;
            return u(d, Rk(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                O: !0
            }, function(e) {
                return $k(e.objectStore("LogsRequestsStore"), {}, function(f) {
    ...
    function mm(a) {
        M("nwl_csi_killswitch") || .01 >= Math.random() && Zl("nwl_transaction_latency_payload", a)
    };
    var tm = {},
        um = hm("ServiceWorkerLogsDatabase", {
            za: (tm.SWHealthLog = {
                Xa: 1
            }, tm),
            lb: !0,
            upgrade: function(a, b) {
                b(1) && Sk(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function wm(a) {
        var b, c;
        return w(function(d) {
            if (1 == d.i) return u(d, vm(a), 2);
            b = d.j;
            c = P() - 2592E6;
            return u(d, Rk(b, ["SWHealthLog"], {
                mode: "readwrite",
                O: !0
            }, function(e) {
                return $k(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.getValue().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
    ...
    function xm(a) {
        var b;
        return w(function(c) {
            if (1 == c.i) return u(c, vm(a), 2);
            b = c.j;
            return u(c, b.clear("SWHealthLog"), 0)
        })
    };
    var ym = {},
        zm = 0;
    ...
    function Am(a) {
        ...
        var c = void 0 === c ? !1 : c;
        if (a)
            if (b) Li(a, void 0, "POST", b);
            else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) Li(a, void 0, "GET", "", void 0, void 0, c);
        else {
            b: {
                try {
                    var d = new $a({
    ...
    function Dm() {
        if (!Cm.i) {
            var a = A("yt.networkRequestMonitor.instance") || new Cm;
            z("yt.networkRequestMonitor.instance", a);
            Cm.i = a
        }
        return Cm.i
    }
    Cm.prototype.requestComplete = function(a, b) {
        b && (this.j = !0);
        a = this.removeParams(a);
        this.i.get(a) || this.i.set(a, b)
    };
    Cm.prototype.isEndpointCFR = function(a) {
        a = this.removeParams(a);
        return (a = this.i.get(a)) ? !1 : !1 === a && this.j ? !0 : null
    };
    Cm.prototype.removeParams = function(a) {
        return a.split("?")[0]
    };
    Cm.prototype.removeParams = Cm.prototype.removeParams;
    Cm.prototype.isEndpointCFR = Cm.prototype.isEndpointCFR;
    Cm.prototype.requestComplete = Cm.prototype.requestComplete;
    Cm.getInstance = Dm;
    var Em;

    function Fm() {
        Em || (Em = new Mj("yt.offline"));
        return Em
    }
    ...
    var Im = bi("network_polling_interval", 3E4);
    ...
    function Jm() {
        ...
        this.A = this.o = !1;
        this.l = this.cb();
        M("use_shared_nsm") ? (this.j = ff(), M("use_shared_nsm_and_keep_yt_online_updated") && (this.j.U("networkstatus-online", function() {
            a.l = !0;
            a.A && Hm()
    ...
    function Mm() {
        if (!Jm.i) {
            var a = A("yt.networkStatusManager.instance") || new Jm;
    ...
    l.fc = function(a) {
        !M("use_shared_nsm") && (this.o = !0, void 0 === a ? 0 : a) && (this.R || Nm(this))
    };
    l.cb = function() {
    ...
    l.U = function(a, b) {
        return M("use_shared_nsm") && this.j ? this.j.U(a, b) : $e.prototype.U.call(this, a, b)
    };

    function Lm(a) {
        window.addEventListener("online", function() {
            return w(function(b) {
                if (1 == b.i) return u(b, a.ca(), 2);
                a.A && Hm();
                b.i = 0
            })
        })
    ...
    function Nm(a) {
        a.R = Vj(function() {
            return w(function(b) {
                if (1 == b.i) return a.l ? a.cb() || !a.o ? b.u(3) : u(b, a.ca(), 3) : u(b, a.ca(), 3);
                Nm(a);
                b.i = 0
            })
        }, Im)
    ...
    l.ca = function(a) {
        ...
        if (M("use_shared_nsm") && this.j) {
            var c = df(this.j, a);
            c.then(function(d) {
                M("use_cfr_monitor") && Dm().requestComplete("generate_204", d)
            });
            return c
        }
        return this.v ? this.v : this.v = new Promise(function(d) {
            ...
            return w(function(k) {
                switch (k.i) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, wa(k, 2, 3), e && (b.N = gf.M(function() {
                            e.abort()
                        }, a || 2E4)), u(k, fetch("/generate_204", {
                            method: "HEAD",
                            signal: g
                        }), 5);
                    case 5:
                    ...
                    case 3:
                        za(k);
                        M("use_cfr_monitor") && Dm().requestComplete("generate_204", h);
                        b.v = void 0;
                        b.N && gf.S(b.N);
                        h !== b.l && (b.l = h, b.l && b.o ? af(b, "ytnetworkstatus-online") : b.o && af(b, "ytnetworkstatus-offline"));
                        d(h);
                        Aa(k);
                        break;
                    case 2:
    ...
    Jm.prototype.sendNetworkCheckRequest = Jm.prototype.ca;
    Jm.prototype.listen = Jm.prototype.U;
    Jm.prototype.enableErrorFlushing = Jm.prototype.Wb;
    Jm.prototype.getWindowStatus = Jm.prototype.cb;
    Jm.prototype.monitorNetworkStatusChange = Jm.prototype.fc;
    Jm.prototype.networkStatusHint = Jm.prototype.aa;
    Jm.prototype.isNetworkAvailable = Jm.prototype.H;
    Jm.getInstance = Mm;
    ...
    function Om(a) {
        ...
        c && c(a.vb);
        a.Db && (c = A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j)) && c();
        if (c = A("yt.networkStatusManager.instance.listen").bind(this.j)) a.Ua ? (this.Ua = a.Ua, c(this.v,
            function() {
                Pm(b, "publicytnetworkstatus-online")
            }), c(this.o, function() {
            Pm(b, "publicytnetworkstatus-offline")
        })) : (c(this.v, function() {
    ...
    Om.prototype.aa = function(a) {
        var b = A("yt.networkStatusManager.instance.networkStatusHint").bind(this.j);
        b && b(a)
    };
    Om.prototype.ca = function(a) {
        var b = this,
            c;
        return w(function(d) {
            c = A("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.j);
            return M("skip_network_check_if_cfr") && Dm().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
    ...
    function Pm(a, b) {
        a.Ua ? a.l ? (gf.S(a.N), a.N = gf.M(function() {
            a.A !== b && (af(a, b), a.A = b, a.l = P())
        }, a.Ua - (P() - a.l))) : (af(a, b), a.A = b, a.l = P()) : af(a, b)
    };
    var Qm;
    ...
    function Rm() {
        Kl.call(this, {
            ...
            Na: !0,
            Ma: .1,
            Sa: bi("potential_esf_error_limit", 10),
            F: M,
            xa: !(ok() && Um())
        });
        this.l = new Kd;
        M("networkless_immediately_drop_all_requests") && sm();
        Jl("LogsDatabaseV2")
    }
    r(Rm, Kl);
    ...
    function Vm() {
        ...
        a || (a = new Rm, z("yt.networklessRequestController.instance", a), M("networkless_logging") && yl().then(function(b) {
            a.C = b;
            Ml(a);
            a.l.resolve();
            a.Na && Math.random() <= a.Ma && a.C && wm(a.C);
            M("networkless_immediately_drop_sw_health_store") && Wm(a)
        }));
        return a
    }
    Rm.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        ok() || (this.i = !1);
        Kl.prototype.writeThenSend.call(this, a, b)
    };
    Rm.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        ok() || (this.i = !1);
        Kl.prototype.sendThenWrite.call(this, a, b, c)
    };
    Rm.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        ok() || (this.i = !1);
        Kl.prototype.sendAndWrite.call(this, a, b)
    };
    Rm.prototype.awaitInitialization = function() {
    ...
    function Wm(a) {
        var b;
        w(function(c) {
            if (!a.C) throw b = Dk("clearSWHealthLogsDb"), b;
            return c.return(xm(a.C).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    var Ym = !1,
        Zm = 0,
        $m = 0,
        an, bn = y.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: Ym,
            potentialEsfErrorCounter: $m
        };
    z("ytNetworklessLoggingInitializationOptions", bn);
    ...
    function cn() {
        ...
        w(function(b) {
            switch (b.i) {
                ...
                case 2:
                    a = b.j;
                    if (!a || !ok() && !M("nwl_init_require_datasync_id_killswitch") || !Um()) {
                        b.u(0);
                        break
                    }
                    Ym = !0;
                    bn.isNwlInitialized = Ym;
                    if (!M("use_new_nwl_initialization")) {
                        b.u(4);
                        break
                    }
                    return u(b, Vm().awaitInitialization(), 5);
                case 5:
                    return b.return();
                case 4:
                    return u(b, Jl("LogsDatabaseV2"), 6);
                case 6:
                    if (!(.1 >= Math.random())) {
                        b.u(7);
                        break
                ...
                case 7:
                    dn();
                    en().H() && fn();
                    en().U("publicytnetworkstatus-online",
                        fn);
                    en().U("publicytnetworkstatus-offline", gn);
                    ...
                    return u(b, hn(), 10);
                case 10:
                    if (M("networkless_immediately_drop_all_requests")) return u(b, sm(), 0);
                    b.u(0)
            }
        })
    }
    ...
    function jn(a, b) {
        function c(d) {
            var e = en().H();
            if (!kn() || !d || e && M("vss_networkless_bypass_write")) ln(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        M("skip_is_supported_killswitch") ? yl().then(function(d) {
            c(d)
        }) : c(xl())
    }
        ...
        function c(d) {
            if (kn() && d) {
                ...
                e.options.onSuccess = function(k, m) {
                    M("use_cfr_monitor") && Dm().requestComplete(e.url, !0);
                    void 0 !== e.id ? qm(e.id, d) : f = !0;
                    M("vss_network_hint") && en().aa(!0);
                    g(k, m)
                };
                if (M("use_cfr_monitor")) {
                    var h = b.onError ? b.onError : function() {};
                    e.options.onError = function(k, m) {
                        Dm().requestComplete(e.url, !1);
                        h(k, m)
                    }
                }
                ln(e.url, e.options);
                lm(e, d).then(function(k) {
                    e.id = k;
                    f && qm(e.id, d)
                }).catch(function(k) {
                    en().H() ? hi(k) : Gm(k)
    ...
    function fn() {
        var a = xl();
        if (!a) throw Dk("throttleSend");
        Zm || (Zm = gf.M(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return u(c, nm("NEW", a), 2);
                if (3 != c.i) return b = c.j, b ? u(c, mn(b), 3) : (gn(), c.return());
                Zm && (Zm = 0, fn());
                c.i = 0
            })
        }, 100))
    ...
    function mn(a) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    b = xl();
                    if (!b) throw c = Dk("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.u(2);
                        break
                    }
                    return u(e, om(a.id, b), 3);
                case 3:
                    (d = e.j) ? a = d: ii(Error("The request cannot be found in the database."));
                case 2:
                    if (on(a, 2592E6)) {
                        e.u(4);
                        break
                    }
                    ii(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.u(5);
                        break
                    }
                    return u(e, qm(a.id, b), 5);
                case 5:
                    return e.return();
                case 4:
                    a.skipRetry || (a = pn(a));
                    ...
                    return u(e, qm(a.id, b), 8);
                case 8:
                    ln(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    ...
    function pn(a) {
        var b = xl();
        if (!b) throw Dk("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return w(function(m) {
                switch (m.i) {
                    case 1:
                        M("use_cfr_monitor") && Dm().requestComplete(a.url, !1);
                        g = Sl(f);
                        if (!(M("nwl_consider_error_code") && g || !M("nwl_consider_error_code") && qn() <= bi("potential_esf_error_limit", 10))) {
                            m.u(2);
                            break
                        }
                        if (M("skip_checking_network_on_cfr_failure") && (!M("skip_checking_network_on_cfr_failure") || Dm().isEndpointCFR(a.url))) {
                            m.u(3);
                            break
                        }
                        return u(m, en().ca(), 3);
                    case 3:
                        ...
                        return u(m, pm(a.id, b, !1), 6);
                    case 6:
                        return m.return();
                    case 2:
                        if (M("nwl_consider_error_code") && !g && qn() > bi("potential_esf_error_limit", 10)) return m.return();
                        A("ytNetworklessLoggingInitializationOptions") && bn.potentialEsfErrorCounter++;
                        $m++;
                        if (void 0 === (null == (k = a) ? void 0 : k.id)) {
                            m.u(8);
                            break
                        }
                        return 1 > a.sendCount ? u(m, pm(a.id, b), 12) : u(m, qm(a.id, b), 8);
                    case 12:
                        gf.M(function() {
                            en().H() && fn()
                        }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            var g;
            return w(function(h) {
                if (1 == h.i) return M("use_cfr_monitor") && Dm().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.u(2) : u(h, qm(a.id, b), 2);
                M("vss_network_hint") && en().aa(!0);
                d(e, f);
                h.i = 0
            })
    ...
    function dn() {
        var a = xl();
        if (!a) throw Dk("retryQueuedRequests");
        nm("QUEUED", a).then(function(b) {
            b && !on(b, 12E4) ? gf.M(function() {
                return w(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.u(2) : u(c, pm(b.id, a), 2);
                    dn();
                    c.i = 0
                })
            }) : en().H() && fn()
    ...
    function hn() {
        ...
        return w(function(c) {
            a = xl();
            if (!a) throw b = Dk("clearSWHealthLogsDb"), b;
            return c.return(xm(a).catch(function(d) {
                hi(d)
            }))
        })
    }
    ...
    function kn() {
        return A("ytNetworklessLoggingInitializationOptions") ? bn.isNwlInitialized : Ym
    }

    function qn() {
        return A("ytNetworklessLoggingInitializationOptions") ? bn.potentialEsfErrorCounter : $m
    };

    function rn(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : Cj() && (this.config_ = Dj());
        Vj(function() {
            Sj(b)
        }, 5E3)
    }
    rn.prototype.isReady = function() {
        !this.config_ && Cj() && (this.config_ = Dj());
        return !!this.config_
    };
    ...
    function Tj(a, b, c, d) {
        function e(D) {
            D = void 0 === D ? !1 : D;
            var G;
            if (d.retry && "www.youtube-nocookie.com" != h && (D || M("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (G = Qj(b, c, m, k)), G)) {
                var K = g.onSuccess,
                    N = g.onFetchSuccess;
            ...
            try {
                D && d.retry && !d.Eb.bypassNetworkless ? (g.method = "POST", d.Eb.writeThenSend ? M("use_new_nwl_wts") ? Vm().writeThenSend(v, g) : jn(v, g) : M("use_new_nwl_saw") ? Vm().sendAndWrite(v, g) : nn(v, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), Ii(v, g))
            } catch (O) {
                if ("InvalidAccessError" == O.name) G && (Rj(G), G = 0), ii(Error("An extension is blocking network request."));
                else throw O;
            }
            G && Vj(function() {
                Sj(a)
            }, 5E3)
        }!L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && ii(new Q("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        var v = ui("" + h + p, t || {}, !0);
        M("use_new_nwl") && Vm().i || !M("use_new_nwl") &&
            kn() ? wl().then(function(D) {
                e(D)
            }) : e(!1)
    };
    var sn = {
    ...
    var un = 0,
        vn = wc ? "webkit" : vc ? "moz" : tc ? "ms" : pc ? "o" : "";
    ...
    function xn(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in wn || (this[b] = a[b]);
                this.scale = a.scale;
    ...
    function Cn(a, b, c, d) {
        ...
        var g = f ? function(h) {
            h = new xn(h);
            if (!Sd(h.relatedTarget, function(k) {
                    return k == a
        ...
        g = gi(g);
        a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Bn() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
        mb[e] = [a, b, c, g, d];
        return e
    }
        ...
        a && ("string" == typeof a && (a = [a]), db(a, function(b) {
            if (b in mb) {
                var c = mb[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Bn() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete mb[b]
            }
        }))
    };
    var En = window.ytcsi && window.ytcsi.now ? window.ytcsi.now : window.performance && window.performance.timing && window.performance.now && window.performance.timing.navigationStart ? function() {
    ...
    function Fn(a) {
        ...
        this.m = 0;
        this.R = Cn(window, "mousemove", Va(this.W, this));
        a = Va(this.N, this);
        "function" === typeof a && (a = gi(a));
        this.ea = window.setInterval(a, 25)
    }
    Xa(Fn, I);
    Fn.prototype.W = function(a) {
        void 0 === a.i && yn(a);
        var b = a.i;
        void 0 === a.j && yn(a);
        this.j = new Od(b, a.j)
    ...
    function Hn(a) {
        var b = void 0 === a ? {} : a;
        a = void 0 === b.jc ? !1 : b.jc;
        b = void 0 === b.Xb ? !0 : b.Xb;
        if (null == A("_lact", window)) {
            var c = parseInt(L("LACT"), 10);
            c = isFinite(c) ? Date.now() - Math.max(c, 0) : -1;
            z("_lact", c, window);
            z("_fact", c, window); - 1 == c && In();
            Cn(document, "keydown", In);
            Cn(document, "keyup", In);
            Cn(document, "mousedown", In);
            Cn(document, "mouseup", In);
            a ? Cn(window, "touchmove", function() {
                Jn("touchmove", 200)
            }, {
                passive: !0
            }) : (Cn(window, "resize", function() {
                Jn("resize", 200)
            }), b && Cn(window, "scroll", function() {
                Jn("scroll", 200)
            }));
            new Fn(function() {
                Jn("mouse", 100)
            });
            Cn(document, "touchstart", In, {
                passive: !0
            });
            Cn(document, "touchend", In, {
                passive: !0
            })
        }
    }
    ...
    var Ln = y.ytPubsubPubsubInstance || new J,
        Mn = y.ytPubsubPubsubSubscribedKeys || {},
        Nn = y.ytPubsubPubsubTopicToKeys || {},
        On = y.ytPubsubPubsubIsSynchronous || {};
    ...
    function Pn(a, b) {
        ...
        if (c && b) {
            var d = c.subscribe(a, function() {
                var e = arguments;
                var f = function() {
                    Mn[d] && b.apply && "function" == typeof b.apply && b.apply(window, e)
                };
                try {
                    On[a] ? f() : Bi(f, 0)
                } catch (g) {
    ...
    J.prototype.publish = J.prototype.ia;
    J.prototype.clear = J.prototype.clear;
    z("ytPubsubPubsubInstance", Ln);
    z("ytPubsubPubsubTopicToKeys", Nn);
    z("ytPubsubPubsubIsSynchronous", On);
    z("ytPubsubPubsubSubscribedKeys", Mn);
    var Vn = y.window;
    Vn.ytExports || (Vn.ytExports = {
        logging: {
            transport: {
                leaderQueueLength: 0,
                leaderChosen: !1
    ...
    var Wn = bi("initial_gel_batch_timeout", 2E3),
        Xn = Math.pow(2, 16) - 1,
        Yn = !1,
        Zn = void 0;
    ...
    var ro = new $n,
        Qo = new $n,
        Ro = !0,
        So = y.ytLoggingTransportGELQueue_ || new Map;
    z("ytLoggingTransportGELQueue_", So);
    var To = new Map,
        Uo = y.ytLoggingTransportGELProtoQueue_ || new Map;
    z("ytLoggingTransportGELProtoQueue_", Uo);
    var Vo = y.ytLoggingTransportTokensToCttTargetIds_ || {};
    z("ytLoggingTransportTokensToCttTargetIds_", Vo);
    var Wo = y.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    z("ytLoggingTransportTokensToJspbCttTargetIds_", Wo);

    function Xo() {
        M("jspb_with_transport_leader") && !Vn.ytExports.logging.transport.leaderChosen && (Yn = Vn.ytExports.logging.transport.leaderChosen = !0, document.addEventListener("FLUSH_REQUEST", function() {
            Yo(void 0, void 0, !0)
        }))
    }
    ...
    function bp(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            var c = $o(a, !0);
            if (M("jspb_with_transport_leader") && Yn) {
                var d = To.get(c) || [];
                To.set(c, d);
                Vn.ytExports.logging.transport.leaderQueueLength++;
                d.push(a.payload);
                ap(b, d, c, !0)
            } else d = Uo.get(c) || [], Uo.set(c, d), a = a.payload.toJSON(), d.push(a), ap(b, d, c, !0)
        }
    }
    ...
    function ap(a, b, c, d) {
        d = void 0 === d ? !1 : d;
        a && (Zn = new a);
        a = bi("tvhtml5_logging_max_batch") || bi("web_logging_max_batch") || 100;
        var e = P(),
            f = d ? Qo.l : ro.l,
            g = Uo.get(c) || [];
        M("jspb_with_transport_leader") && (Yn && b.length + g.length >= a || !Yn && Vn.ytExports.logging.transport.leaderQueueLength + b.length >= a) || b.length >= a ? Yo({
            writeThenSend: !0
        }, M("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && (cp(d), d ? Qo.l = e : ro.l = e)
    }
    ...
    function dp(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            d.set(c, [a.payload]);
            b && (Zn = new b);
            return new Zf(function(e, f) {
                Zn && Zn.isReady() ? ep(d, e, f, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function fp(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            var c = $o(a, !0),
                d = new Map,
                e = new Map;
            M("jspb_with_transport_leader") && Yn ? e.set(c, [a.payload]) : d.set(c, [a.payload.toJSON()]);
            b && (Zn = new b);
            return new Zf(function(f) {
                Zn && Zn.isReady() ? gp(d, e, f, {
                    bypassNetworkless: !0
                }, !0) : f()
            })
        }
    ...
    function $o(a, b) {
        ...
        if (a.wa) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.cttAuthInfo;
                var d = new Qh;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && vd(d, 2, Rh, c.playlistId);
                Wo[b] = d
            } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Vo[a.cttAuthInfo.token] = c;
    ...
    function Yo(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new Zf(function(d, e) {
            c ? (Ci(Qo.j), Ci(Qo.i), Qo.i = 0) : (Ci(ro.j), Ci(ro.i), ro.i = 0);
            if (M("jspb_with_transport_leader") && !Yn) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
            else if (Zn && Zn.isReady())
                if (void 0 !== b)
                    if (c) {
                        e = new Map;
                        var f = new Map,
                            g = Uo.get(b) || [];
                        e.set(b, g);
                        M("jspb_with_transport_leader") && (g = To.get(b) || [], f.set(b, g));
                        gp(e, f, d, a);
                        Uo.delete(b)
                    } else f = new Map, g = So.get(b) || [], f.set(b, g), ep(f, d, e, a), So.delete(b);
            else c ? (gp(Uo, To, d,
                a), Uo.clear()) : (ep(So, d, e, a), So.clear());
            else cp(c), d()
        })
    }
    ...
    function cp(a) {
        a = void 0 === a ? !1 : a;
        if (M("web_gel_timeout_cap") && (!a && !ro.i || a && !Qo.i)) {
            var b = Bi(function() {
                Yo({
                    writeThenSend: !0
                }, void 0, a)
        ...
        Ci(a ? Qo.j : ro.j);
        b = L("LOGGING_BATCH_TIMEOUT", bi("web_gel_debounce_ms", 1E4));
        M("shorten_initial_gel_batch_timeout") && Ro && (b = Wn);
        b = Bi(function() {
            Yo({
                writeThenSend: !0
            }, void 0, a)
    ...
    function ep(a, b, c, d, e) {
        ...
        for (var k = a.next(); !k.done; k = a.next()) {
            ...
            try {
                Tj(f, "log_event", k, kp(d, m, p, t, e)), Ro = !1
            } catch (x) {
                hi(x), c()
            }
        }
    ...
    function gp(a, b, c, d, e) {
        ...
        var g = Math.round(P()),
            h = a.size + b.size,
            k = new Map([].concat(fa(a), fa(b)));
        k = q(k);
        for (var m = k.next(); !m.done; m = k.next()) {
            var p = q(m.value).next().value,
                t = a.get(p),
                x = b.get(p) || [];
            m = new Sh;
            var v = Jj(f.config_ || Dj());
            E(m, Xg, 1, v);
            t = t ? lp(t) : [];
            t = q(t);
            for (v = t.next(); !v.done; v = t.next()) Ad(m, 3, Mh, v.value);
            x = q(x);
            for (t = x.next(); !t.done; t = x.next()) Ad(m, 3, Mh, t.value);
            (x = Wo[p]) && mp(m, p, x);
            delete Wo[p];
            p = "visitorOnlyApprovedKey" === p;
            np(m, g, p);
            jp(d);
            a: {
                ad = !0;
            ...
            m = D;
            p = kp(d, p, function() {
                Vn.ytExports.logging.transport.leaderQueueLength = 0;
                h--;
                h || c()
            }, function() {
                Vn.ytExports.logging.transport.leaderQueueLength = 0;
    ...
    function ip(a, b, c) {
        ...
        !c && (b = L("EVENT_ID")) && (c = op(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function op() {
        ...
        a || (a = Math.floor(Math.random() * Xn / 2));
        a++;
        a > Xn && (a = 1);
    ...
    function lp(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            hi(new Q("Transport failed to deserialize " + String(a[c])))
        }
        return b
    };
    var pp = y.ytLoggingGelSequenceIdObj_ || {};
    z("ytLoggingGelSequenceIdObj_", pp);

    function qp(a, b, c, d) {
        d = void 0 === d ? {} : d;
        if (M("lr_drop_other_and_business_payloads")) {
            if (tn[a] || sn[a]) return
        } else if (M("lr_drop_other_payloads") && tn[a]) return;
        var e = {},
        ...
        M("log_sequence_info_on_gel_web") && d.V && (a = e.context, b = d.V, b = {
            index: rp(b),
            groupKey: b
        }, a.sequence = b, d.wb && delete pp[d.V]);
        (d.sc ? dp : Zo)({
            endpoint: "log_event",
            payload: e,
    ...
    function lk(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = rn;
        L("ytLoggingEventsDefaultDisabled", !1) && rn == rn && (d = null);
        qp(a, b, d, c)
    };
    var tp = [{
        hb: function(a) {
    ...
    function yp() {
        if (!xp) {
            ...
            a.ga.length = 0;
            a.fa.length = 0;
            vp.ga && a.ga.push.apply(a.ga, vp.ga);
            vp.fa && a.fa.push.apply(a.fa, vp.fa)
        }
        return xp
    };
    var zp = new J;
    ...
    function Cp(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Dp(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Ap(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Dp(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += Dp(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = Ep(a), d += c[b].length;
        else c[b] = Ep(a), d += c[b].length;
        return d
    }
    ...
    var Fp = y.ytLoggingGelSequenceIdObj_ || {};
    z("ytLoggingGelSequenceIdObj_", Fp);
    ...
    function Hp(a, b) {
        b = void 0 === b ? {} : b;
        var c = !1;
        L("ytLoggingEventsDefaultDisabled", !1) && rn === rn && (c = !0);
        Gp(a, c ? null : rn, b)
    };
    ...
    var Pp = new Set,
        ...
        Sp = 0,
        Tp = [],
        Up = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    ...
    function Vp(a, b, c, d, e, f) {
        ...
        if (a) {
            ...
            if (!(5 <= Qp)) {
                var m = Tp,
                    p = ye(a),
                    t = p.message || "Unknown Error",
                    x = p.name || "UnknownError",
                ...
                var G = p.lineNumber || "Not available",
                    K = p.fileName || "Not available",
                    N = v,
                    O = 0;
                if (a.hasOwnProperty("args") && a.args && a.args.length)
                    for (var S = 0; S < a.args.length && !(O = Cp(a.args[S], "params." + S, g, O), 500 <= O); S++);
                        ...
                        for (var V in ka) {
                            if (ka[V]) {
                                var W = "params." + V,
                                    Pa = Ep(ka[V]);
                                g[W] = Pa;
                                O += W.length + Pa.length;
                                if (500 < O) break
                            }
                        } else g.params = Ep(ka)
                }
                if (m.length)
                    for (var va = 0; va < m.length && !(O = Cp(m[va], "params.context." + va, g, O), 500 <= O); va++);
                ...
                isNaN(Ca) || (F.lineNumber = F.lineNumber +
                    ":" + Ca);
                if ("IGNORED" === a.level) var ua = 0;
                else a: {
                    for (var ao = yp(), bo = q(ao.ga), bj = bo.next(); !bj.done; bj = bo.next()) {
                        var co = bj.value;
                        if (F.message && F.message.match(co.xp)) {
                            ua = co.weight;
                            break a
                        }
                    }
                    for (var eo = q(ao.fa), cj = eo.next(); !cj.done; cj = eo.next()) {
                        var fo = cj.value;
                        if (fo.ka(F)) {
                            ua = fo.weight;
                            break a
                ...
                F.sampleWeight = ua;
                for (var go = q(tp), dj = go.next(); !dj.done; dj = go.next()) {
                    var ej = dj.value;
                    if (ej.Ra[F.name])
                        for (var ho = q(ej.Ra[F.name]), fj = ho.next(); !fj.done; fj = ho.next()) {
                            var io = fj.value,
                                hg = F.message.match(io.regexp);
                            if (hg) {
                                F.params["params.error.original"] = hg[0];
                                for (var gj = io.groups, jo = {}, ed = 0; ed < gj.length; ed++) jo[gj[ed]] = hg[ed + 1], F.params["params.error." + gj[ed]] = hg[ed + 1];
                                F.message = ej.hb(jo);
                                break
                            }
                        }
                ...
                F.params || (F.params = {});
                var ko = yp();
                F.params["params.errorServiceSignature"] = "msg=" + ko.ga.length + "&cb=" + ko.fa.length;
                F.params["params.serviceWorker"] = "false";
                y.document && y.document.querySelectorAll && (F.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length));
                Bb("sample").constructor !==
                    zb && (F.params["params.fconst"] = "true");
                window.yterr && "function" === typeof window.yterr && window.yterr(F);
                if (0 !== F.sampleWeight && !Pp.has(F.message)) {
                    if ("ERROR" === h) {
                        zp.ia("handleError", F);
                        if (M("record_app_crashed_web") && 0 === Sp && 1 === F.sampleWeight)
                            if (Sp++, M("errors_via_jspb")) {
                                var hj = new jh;
                                C(hj, 1, 1);
                                ...
                                M("report_client_error_with_app_crash_ks") || (qo.systemHealth = {
                                    crashData: {
                                        clientError: {
                                            logMessage: {
                                                message: F.message
                    ...
                    } else "WARNING" === h && zp.ia("handleWarning", F);
                    if (M("kevlar_gel_error_routing")) a: {
                        ...
                        if (M("errors_via_jspb")) {
                            if (Xp()) var so = void 0;
                                ...
                                var fd = new bh;
                                C(fd, 1, F.stack);
                                F.fileName && C(fd, 4, F.fileName);
                                var tb = F.lineNumber && F.lineNumber.split ? F.lineNumber.split(":") : [];
                                0 !== tb.length && (1 !==
                                    tb.length || isNaN(Number(tb[0])) ? 2 !== tb.length || isNaN(Number(tb[0])) || isNaN(Number(tb[1])) || (C(fd, 2, Number(tb[0])), C(fd, 3, Number(tb[1]))) : C(fd, 2, Number(tb[0])));
                                var qc = new eh;
                                C(qc, 1, F.message);
                                C(qc, 3, F.name);
                                C(qc, 6, F.sampleWeight);
                                "ERROR" === ie ? C(qc, 2, 2) : "WARNING" === ie ? C(qc, 2, 1) : C(qc, 2, 0);
                                var ij = new ch;
                                C(ij, 1, !0);
                                zd(ij, bh, 3, dh, fd);
                                var Qb = new Zg;
                                C(Qb, 3, window.location.href);
                                for (var to = L("FEXP_EXPERIMENTS", []), jj = 0; jj < to.length; jj++) {
                                    var It = to[jj];
                                    cd(Qb);
                                    ud(Qb, 5).push(It)
                                }
                                var kj = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                                if (!$h() && kj)
                                    for (var uo = q(Object.keys(kj)), rc = uo.next(); !rc.done; rc = uo.next()) {
                                        var vo = rc.value,
                                            lj = new ah;
                                        C(lj, 1, vo);
                                        lj.setValue(String(kj[vo]));
                                        Ad(Qb, 4, ah, lj)
                                    }
                                var mj = F.params;
                                if (mj) {
                                    var wo = q(Object.keys(mj));
                                    for (rc = wo.next(); !rc.done; rc = wo.next()) {
                                        var xo = rc.value,
                                            nj = new ah;
                                        C(nj, 1, "client." + xo);
                                        nj.setValue(String(mj[xo]));
                                        Ad(Qb, 4, ah, nj)
                                    }
                                }
                                var yo = L("SERVER_NAME"),
                                    zo = L("SERVER_VERSION");
                                if (yo && zo) {
                                    var oj = new ah;
                                    C(oj, 1, "server.name");
                            ...
                            if (Xp()) var Co = void 0;
                                ...
                                F.fileName && (je.filename = F.fileName);
                                var ub = F.lineNumber && F.lineNumber.split ? F.lineNumber.split(":") : [];
                                0 !== ub.length && (1 !== ub.length || isNaN(Number(ub[0])) ? 2 !== ub.length || isNaN(Number(ub[0])) || isNaN(Number(ub[1])) || (je.lineNumber = Number(ub[0]), je.columnNumber = Number(ub[1])) : je.lineNumber =
                                    Number(ub[0]));
                                var qj = {
                                ...
                                "ERROR" === ie ? qj.level = "ERROR_LEVEL_ERROR" : "WARNING" === ie && (qj.level = "ERROR_LEVEL_WARNNING");
                                var Jt = {
                                        isObfuscated: !0,
                                        browserStackInfo: je
                                    },
                                ...
                                L("FEXP_EXPERIMENTS") && (gd.experimentIds = L("FEXP_EXPERIMENTS"));
                                var rj = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                                if (!$h() && rj)
                                    for (var Do = q(Object.keys(rj)), sc = Do.next(); !sc.done; sc = Do.next()) {
                                        var Eo =
                                            sc.value;
                                        gd.kvPairs.push({
                                            key: Eo,
                                ...
                                var sj = F.params;
                                if (sj) {
                                    var Fo = q(Object.keys(sj));
                                    for (sc = Fo.next(); !sc.done; sc = Fo.next()) {
                                        var Go = sc.value;
                                        gd.kvPairs.push({
                                            key: "client." + Go,
                                            value: String(sj[Go])
                                ...
                                var Ho = L("SERVER_NAME"),
                                    Io = L("SERVER_VERSION");
                                Ho && Io && (gd.kvPairs.push({
                                    key: "server.name",
                                    value: Ho
                                }), gd.kvPairs.push({
                                    key: "server.version",
                        ...
                        if ("ERROR" === ie || M("errors_flush_gel_always_killswitch")) M("web_fp_via_jspb") &&
                            sp(!0),
                        sp()
                    }
                    if (!M("suppress_error_204_logging")) {
                        ...
                        ke.version && (Rb["client.version"] = ke.version);
                        if (Rb.postParams) {
                            F.stack && (Rb.postParams.stack = F.stack);
                            for (var Ko = q(Object.keys(ke)), tj = Ko.next(); !tj.done; tj = Ko.next()) {
                                var Lo = tj.value;
                                Rb.postParams["client." + Lo] = ke[Lo]
                            }
                            var uj =
                                L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                            if (uj)
                                for (var Mo = q(Object.keys(uj)), vj = Mo.next(); !vj.done; vj = Mo.next()) {
                                    var No = vj.value;
                                    Rb.postParams[No] = uj[No]
                                }
                            var Oo = L("SERVER_NAME"),
                                Po = L("SERVER_VERSION");
                            Oo && Po && (Rb.postParams["server.name"] = Oo, Rb.postParams["server.version"] = Po)
                        }
                        Ii(L("ECATCHER_REPORT_HOST", "") + "/error_204", Rb)
                    }
                    try {
                        Pp.add(F.message)
                    } catch (gv) {}
    ...
    function Xp() {
        for (var a = q(Up), b = a.next(); !b.done; b = a.next())
            if (ck(b.value.toLowerCase())) return !0;
        return !1
    }
    ...
    function $p(a) {
        ...
        for (var b = a.next(); !b.done; b = a.next()) b.value.Ap("ABORTED")
    }
    ...
    function cq() {
        a: {
            ...
            if (bq)
                for (a = 1, b = 0; b < bq.length; b++) d[a % 16] = d[a % 16] ^ d[(a - 1) % 16] / 4 ^ bq.charCodeAt(b), a++
        }
        a = [];
        for (b = 0; b < d.length; b++) a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b] & 63));
        return a.join("")
    };
    var dq = y.ytLoggingDocDocumentNonce_;
    dq || (dq = cq(), z("ytLoggingDocDocumentNonce_", dq));
    var eq = dq;
    var fq = {
        Jg: 0,
        wd: 1,
    ...
    gq.prototype.getAsJson = function() {
        var a = {};
    ...
    gq.prototype.getAsJspb = function() {
        var a = new lh;
        ...
        void 0 !== this.i.youtubeData && E(a, Jg, 8, this.i.jspbYoutubeData);
        return a
    };
    gq.prototype.toString = function() {
        return JSON.stringify(this.getAsJson())
    };
    gq.prototype.isClientVe = function() {
    ...
    function kq(a) {
        return L(jq(void 0 === a ? 0 : a))
    }
    z("yt_logging_screen.getRootVeType", kq);

    function lq(a) {
        return (a = kq(void 0 === a ? 0 : a)) ? new gq({
            veType: a,
            youtubeData: void 0,
    ...
    z("yt_logging_screen.getCurrentCsn", nq);
    ...
    function qq(a, b, c, d) {
        c = void 0 === c ? 0 : c;
        if (a !== L(iq(c)) || b !== L(jq(c))) oq(a, d, c), Zh(iq(c), a), Zh(jq(c), b), b = function() {
                setTimeout(function() {
                    if (a)
                        if (M("web_time_via_jspb")) {
                            ...
                            C(e, 1, eq);
                            C(e, 2, a);
                            M("use_default_heartbeat_client") ? Op(e) : Op(e, void 0, rn)
                        } else e = {
                            clientDocumentNonce: eq,
                            clientScreenNonce: a
                        }, M("use_default_heartbeat_client") ? lk("foregroundHeartbeatScreenAssociated", e) : qp("foregroundHeartbeatScreenAssociated", e, rn)
                }, 0)
            }, "requestAnimationFrame" in window ? window.requestAnimationFrame(b) :
            b()
    }
    z("yt_logging_screen.setCurrentScreen", qq);
    var rq = window.yt && window.yt.msgs_ || window.ytcfg && window.ytcfg.msgs || {};
    z("yt.msgs_", rq);
    ...
    function uq() {
        ...
        return fg(new Zf(function(c, d) {
            a.onSuccess = function(e) {
                Ai(e) ? c(new wq(e)) : d(new xq("Request failed, status=" + (e && "status" in e ? e.status : -1), "net.badstatus", e))
            };
            a.onError = function(e) {
                d(new xq("Unknown request error", "net.unknown", e))
            };
            a.onTimeout = function(e) {
                d(new xq("Request timed out", "net.timeout", e))
            };
            b = Ii("//googleads.g.doubleclick.net/pagead/id", a)
        }), function(c) {
    ...
    yq.prototype.then = function(a, b, c) {
        return 1 === this.i && a ? (a = a.call(c, this.da)) && "function" === typeof a.then ? a : zq(a) : 2 === this.i && b ? (a = b.call(c, this.da)) && "function" === typeof a.then ? a : Aq(a) : this
    };
    yq.prototype.getValue = function() {
        return this.da
    };
    yq.prototype.$goog_Thenable = !0;

    function Aq(a) {
        var b = new yq;
        a = void 0 === a ? null : a;
        b.i = 2;
        b.da = void 0 === a ? null : a;
        return b
    }
    ...
    function Bq(a, b) {
        return {
            ...
            mode: vi(a) ? "same-origin" : "cors",
            credentials: vi(a) ? "same-origin" : "include"
        }
    };

    function Cq() {
        if (re() || bk && ck("applewebkit") && !ck("version") && (!ck("safari") || ck("gsa/")) || xc && ck("version/")) return !0;
        if (M("enable_web_eom_visitor_data")) return L("EOM_VISITOR_DATA") ? !1 : !0;
        var a = L("INNERTUBE_CLIENT_NAME");
        return !a || "WEB" !== a && "MWEB" !== a ? !0 : (a = Ti("CONSENT")) ? a.startsWith("YES+") : !0
    };
    ...
    function Eq(a) {
        ...
        this.isMissing = a instanceof Fq;
        this.isTimeout = a instanceof xq && "net.timeout" == a.errorCode;
    ...
    r(Fq, Za);
    Fq.prototype.name = "BiscottiMissingError";
    var vq = {
            format: "RAW",
            method: "GET",
            timeout: 5E3,
    ...
    function ki() {
        ...
        if (!Cq()) return dg(Error("User has not consented - not fetching biscotti id."));
        var a = L("PLAYER_VARS", {});
        if ("1" == pb(a)) return dg(Error("Biscotti ID is not available in private embed mode"));
        if (M("embeds_web_disable_ads_for_pfl") && Dq(a)) return dg(Error("Biscotti id fetching has been disabled for pfl."));
        Gq || (Gq = fg(uq().then(Hq), function(b) {
            return Iq(2, b)
        }));
        return Gq
    }
    ...
    function Hq(a) {
        ...
        if (0 != a.lastIndexOf(")]}'", 0)) throw new Fq;
        a = JSON.parse(a.substr(4));
        if (1 < (a.type || 1)) throw new Fq;
        a = a.id;
        li(a);
        Gq = zq(a);
        Jq(18E5, 2);
    ...
    function Lq(a) {
        if ("1" != pb(L("PLAYER_VARS", {}))) {
            a && ji();
            try {
                Kq().then(function() {}, function() {}), Bi(Lq, 18E5)
            } catch (b) {
                hi(b)
            }
        }
    ...
    function Nq(a) {
        var b = {},
            c = te([]);
        c && (b.Authorization = c, c = a = null == a ? void 0 : a.sessionIndex, void 0 === c && (c = Number(L("SESSION_INDEX", 0)), c = isNaN(c) ? 0 : c), M("voice_search_auth_header_removal") || (b["X-Goog-AuthUser"] = c), "INNERTUBE_HOST_OVERRIDE" in Yh || (b["X-Origin"] = window.location.origin), void 0 === a && "DELEGATED_SESSION_ID" in Yh && (b["X-Goog-PageId"] = L("DELEGATED_SESSION_ID")));
        return b
    };
    ...
    Sq.prototype.resolve = function(a) {
        return a instanceof Qq ? Tq(this, a.key, [], !0) : Tq(this, a, [])
    };
    ...
    function Tq(a, b, c, d) {
        ...
        c.push(b);
        if (d.Gc) var e = d.Gc;
        else if (d.Fc) e = d[Oq] ? Uq(a, d[Oq], c) : [], e = d.Fc.apply(d, fa(e));
        else if (d.Nb) {
            e = d.Nb;
            var f = e[Oq] ? Uq(a, e[Oq], c) : [];
    ...
    function Uq(a, b, c) {
        return b ? b.map(function(d) {
            return d instanceof Qq ? Tq(a, d.key, c, !0) : Tq(a, d, c)
        }) : []
    };
    var Vq;
    var Wq = {
    ...
    function Zq() {
        this.i = {};
        if (this.j = Ui()) {
            var a = Ti("CONSISTENCY");
            a && $q(this, {
                encryptedTokenJarContents: a
            })
        }
    }
    Zq.prototype.handleResponse = function(a, b) {
        var c, d;
    ...
    var ar = window.location.hostname.split(".").slice(-2).join(".");

    function br() {
        var a = L("LOCATION_PLAYABILITY_TOKEN");
        "TVHTML5" === L("INNERTUBE_CLIENT_NAME") && (this.i = cr(this)) && (a = this.i.get("yt-location-playability-token"));
        a && (this.locationPlayabilityToken = a, this.j = void 0)
    }
    var dr;
    br.getInstance = function() {
        dr = A("yt.clientLocationService.instance");
        dr || (dr = new br, z("yt.clientLocationService.instance", dr));
        return dr
    };
    br.prototype.setLocationOnInnerTubeContext = function(a) {
        a.client || (a.client = {});
    ...
    br.prototype.handleResponse = function(a) {
        var b;
        a = null == (b = a.responseContext) ? void 0 : b.locationPlayabilityToken;
        void 0 !== a && (this.locationPlayabilityToken = a, this.j = void 0, "TVHTML5" === L("INNERTUBE_CLIENT_NAME") ? (this.i = cr(this)) && this.i.set("yt-location-playability-token", a, 15552E3) : Si("YT_CL", JSON.stringify({
            loctok: a
        }), 15552E3, ar, !0))
    };

    function cr(a) {
        return void 0 === a.i ? new Mj("yt-client-location") : a.i
    }
    ...
    br.prototype.createUnpluggedLocationInfo = function(a) {
        var b = {};
        a = a.coords;
    ...
    function er(a, b) {
        var c;
        if ((null == (c = a.signalServiceEndpoint) ? 0 : c.signal) && b.Ba && (c = b.Ba[a.signalServiceEndpoint.signal])) return c();
        var d;
        if ((null == (d = a.continuationCommand) ? 0 : d.request) && b.Ub && (d = b.Ub[a.continuationCommand.request])) return d();
        for (var e in a)
            if (b.rb[e] && (a = b.rb[e])) return a()
    };
    ...
    var gr = {},
        hr = (gr.WEB_UNPLUGGED = "^unplugged/", gr.WEB_UNPLUGGED_ONBOARDING = "^unplugged/", gr.WEB_UNPLUGGED_OPS = "^unplugged/", gr.WEB_UNPLUGGED_PUBLIC = "^unplugged/", gr.WEB_CREATOR = "^creator/", gr.WEB_KIDS = "^kids/", gr.WEB_EXPERIMENTS = "^experiments/", gr.WEB_MUSIC = "^music/", gr.WEB_REMIX = "^music/", gr.WEB_MUSIC_EMBEDDED_PLAYER = "^music/", gr.WEB_MUSIC_EMBEDDED_PLAYER = "^main_app/|^sfv/", gr);
    ...
    function ir(a) {
        ...
        var f = [];
        Object.entries(hr).forEach(function(g) {
            var h = q(g);
            g = h.next().value;
            h = h.next().value;
            b !== g && f.push(h)
    ...
    jr.prototype.s = function(a, b, c) {
        ...
        if (g) {
            ...
            Zi(165) ? m = "USER_INTERFACE_THEME_DARK" : Zi(174) ? m = "USER_INTERFACE_THEME_LIGHT" : !M("kevlar_legacy_browsers") && window.matchMedia && window.matchMedia("(prefers-color-scheme)").matches && window.matchMedia("(prefers-color-scheme: dark)").matches && (m = "USER_INTERFACE_THEME_DARK");
            k = k ? m : Yq() || m;
            h.userInterfaceTheme = k;
            if (!f) {
                if (k =
                    Aj()) h.connectionType = k;
                M("web_log_effective_connection_type") && (k = Bj()) && (g.client.effectiveConnectionType = k)
            }
            var p;
            if (M("web_log_memory_total_kbytes") && (null == (p = y.navigator) ? 0 : p.deviceMemory)) {
                var t;
                p = null == (t = y.navigator) ? void 0 : t.deviceMemory;
                g.client.memoryTotalKbytes = "" + 1E6 * p
            }
            t = ti(y.location.href);
            ...
            if (!M("web_populate_time_zone_itc_killswitch")) {
                ...
                x && (h.timeZone = x)
            }(x = ci()) ? h.experimentsToken = x: delete h.experimentsToken;
            x = di();
            Zq.i || (Zq.i = new Zq);
            h = Zq.i.i;
            t = [];
            p = 0;
            for (var v in h) t[p++] = h[v];
            ...
            M("warm_op_csn_cleanup") ? e && (f = nq()) && (g.clientScreenNonce = f) : !f && (f = nq()) && (g.clientScreenNonce = f);
            d && (g.clickTracking = {
                clickTrackingParams: d
            });
            if (d = A("yt.mdx.remote.remoteClient_")) g.remoteClient = d;
            M("web_enable_client_location_service") && br.getInstance().setLocationOnInnerTubeContext(g);
            try {
                var D = wi(),
                    G = D.bid;
                delete D.bid;
            ...
            K = g
        } else Vp(Error("Error: No InnerTubeContext shell provided in ytconfig.")), K = {};
        K = {
            context: K
        };
        if (N = this.i(a)) {
            ...
            V.config.Ia ? V.config.Ia.identity = c : V.config.Ia = {
                identity: c
            };
            return V
        }
        Vp(new Q("Error: Failed to create Request from Command.", a))
    };
    da.Object.defineProperties(jr.prototype, {
        m: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    kr.prototype.s = function() {
        return {
            ...
            sa: Bq("/getDatasyncIdsEndpoint", "GET"),
            Z: {}
        }
    };
    ...
    var lr = {},
        mr = (lr.GET_DATASYNC_IDS = fr(kr), lr);

    function nr(a) {
        var b = Ia.apply(1, arguments);
        if (!or(a) || b.some(function(d) {
                return !or(d)
            })) throw Error("Only objects may be merged.");
        b = q(b);
        for (var c = b.next(); !c.done; c = b.next()) pr(a, c.value);
        return a
    }
    ...
    function pr(a, b) {
        for (var c in b)
            if (or(b[c])) {
                if (c in a && !or(a[c])) throw Error("Cannot merge an object into a non-object.");
                c in a || (a[c] = {});
                pr(a[c], b[c])
            } else if (qr(b[c])) {
            if (c in a && !qr(a[c])) throw Error("Cannot merge an array into a non-array.");
            c in a || (a[c] = []);
            rr(a[c], b[c])
        } else a[c] = b[c];
        return a
    ...
    function rr(a, b) {
        b = q(b);
        for (var c = b.next(); !c.done; c = b.next()) c = c.value, or(c) ? a.push(pr({}, c)) : qr(c) ? a.push(rr([], c)) : a.push(c);
        return a
    }
    ...
    function sr(a, b) {
        Tl.call(this, 1, arguments);
        this.timer = b
    }
    r(sr, Tl);
    var tr = new Ul("aft-recorded", sr);
    var ur = window;
    ...
    var R = ur.performance || ur.mozPerformance || ur.msPerformance || ur.webkitPerformance || new vr;
    var wr = !1,
        xr = {
    ...
    Va(R.clearResourceTimings || R.webkitClearResourceTimings || R.mozClearResourceTimings || R.msClearResourceTimings || R.oClearResourceTimings || ab, R);
    ...
    function Ar() {
        ...
        if (M("csi_use_performance_navigation_timing")) {
            var b, c, d, e = null == R ? void 0 : null == (a = R.getEntriesByType) ? void 0 : null == (b = a.call(R, "navigation")) ? void 0 : null == (c = b[0]) ? void 0 : null == (d = c.toJSON) ? void 0 : d.call(c);
            e ? (e.requestStart = Br(e.requestStart), e.responseEnd = Br(e.responseEnd), e.redirectStart = Br(e.redirectStart), e.redirectEnd = Br(e.redirectEnd), e.domainLookupEnd = Br(e.domainLookupEnd), e.connectStart = Br(e.connectStart), e.connectEnd = Br(e.connectEnd), e.responseStart = Br(e.responseStart),
                e.secureConnectionStart = Br(e.secureConnectionStart), e.domainLookupStart = Br(e.domainLookupStart), e.isPerformanceNavigationTiming = !0, a = e) : a = R.timing
        } else a = R.timing;
        return a
    }

    function Cr() {
        return M("csi_use_time_origin") && R.timeOrigin ? Math.floor(R.timeOrigin) : R.timing.navigationStart
    }

    function Br(a) {
        return Math.round(Cr() + a)
    }
    ...
    function Ir(a) {
        var b = zr(a || ""),
            c = yr(a);
        c && !wr && (Zl(tr, new sr(Math.round(c - b._start), a)), wr = !0)
    }

    function Jr(a, b) {
        for (var c = q(Object.keys(b)), d = c.next(); !d.done; d = c.next())
            if (d = d.value, !Object.keys(a).includes(d) || "object" === typeof b[d] && !Jr(a[d], b[d])) return !1;
        return !0
    };

    function Kr() {
        if (R.getEntriesByType) {
            var a = R.getEntriesByType("paint");
            if (a = hb(a, function(b) {
                    return "first-paint" === b.name
                })) return Br(a.startTime)
        }
        a = R.timing;
    ...
    var T = {},
        ...
        Pr = "isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
        Qr = {},
        Rr = (Qr.ccs = "CANARY_STATE_", Qr.mver = "MEASUREMENT_VERSION_", Qr.pis = "PLAYER_INITIALIZED_STATE_", Qr.yt_pt = "LATENCY_PLAYER_", Qr.pa = "LATENCY_ACTION_", Qr.ctop = "TOP_ENTITY_TYPE_", Qr.yt_vst = "VIDEO_STREAM_TYPE_", Qr),
        Sr = "all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");

    function Tr(a) {
        return Nr[a] || "LATENCY_ACTION_UNKNOWN"
    }
    ...
    function Ur(a, b, c) {
        ...
        if (a in Or) {
            c = Or[a];
            0 <= cb(Pr, c) && (b = !!b);
            a in Rr && "string" === typeof b && (b = Rr[a] + b.toUpperCase());
            a = b;
            b = c.split(".");
        ...
        0 <= cb(Sr, a) || Wp(new Q("Unknown label logged with GEL CSI", a))
    };
    var X = {
    ...
    Vr[Vr.LATENCY_NETWORK_MOBILE] = "LATENCY_NETWORK_MOBILE";
    Vr[Vr.LATENCY_NETWORK_WIFI] = "LATENCY_NETWORK_WIFI";
    Vr[Vr.LATENCY_NETWORK_UNKNOWN] = "LATENCY_NETWORK_UNKNOWN";
    var Y = {
        CONN_INVALID: 31,
        CONN_CELLULAR_5G_NSA: 12,
        CONN_CELLULAR_5G_SA: 11,
    ...
    Wr[Wr.LATENCY_PLAYER_RTSP] = "LATENCY_PLAYER_RTSP";
    Wr[Wr.LATENCY_PLAYER_HTML5_INLINE] = "LATENCY_PLAYER_HTML5_INLINE";
    Wr[Wr.LATENCY_PLAYER_HTML5_FULLSCREEN] = "LATENCY_PLAYER_HTML5_FULLSCREEN";
    Wr[Wr.LATENCY_PLAYER_HTML5] = "LATENCY_PLAYER_HTML5";
    Wr[Wr.LATENCY_PLAYER_FRAMEWORK] = "LATENCY_PLAYER_FRAMEWORK";
    Wr[Wr.LATENCY_PLAYER_FLASH] = "LATENCY_PLAYER_FLASH";
    Wr[Wr.LATENCY_PLAYER_EXO] = "LATENCY_PLAYER_EXO";
    Wr[Wr.LATENCY_PLAYER_UNKNOWN] = "LATENCY_PLAYER_UNKNOWN";
    var Xr = {
    ...
    Xr[Xr.LATENCY_AD_BREAK_TYPE_POSTROLL] = "LATENCY_AD_BREAK_TYPE_POSTROLL";
    Xr[Xr.LATENCY_AD_BREAK_TYPE_MIDROLL] = "LATENCY_AD_BREAK_TYPE_MIDROLL";
    Xr[Xr.LATENCY_AD_BREAK_TYPE_PREROLL] = "LATENCY_AD_BREAK_TYPE_PREROLL";
    Xr[Xr.LATENCY_AD_BREAK_TYPE_UNKNOWN] = "LATENCY_AD_BREAK_TYPE_UNKNOWN";
    var Yr = {
        LATENCY_ACTION_ERROR_STARTUP_TIMEOUT: 1,
        LATENCY_ACTION_ERROR_UNSPECIFIED: 0
    };
    Yr[Yr.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT] = "LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";
    Yr[Yr.LATENCY_ACTION_ERROR_UNSPECIFIED] = "LATENCY_ACTION_ERROR_UNSPECIFIED";
    var Zr = {
    ...
    Zr[Zr.LIVE_STREAM_MODE_WINDOW] = "LIVE_STREAM_MODE_WINDOW";
    Zr[Zr.LIVE_STREAM_MODE_POST] = "LIVE_STREAM_MODE_POST";
    Zr[Zr.LIVE_STREAM_MODE_LP] = "LIVE_STREAM_MODE_LP";
    Zr[Zr.LIVE_STREAM_MODE_LIVE] = "LIVE_STREAM_MODE_LIVE";
    Zr[Zr.LIVE_STREAM_MODE_DVR] = "LIVE_STREAM_MODE_DVR";
    Zr[Zr.LIVE_STREAM_MODE_UNKNOWN] = "LIVE_STREAM_MODE_UNKNOWN";
    var $r = {
    ...
    $r[$r.VIDEO_STREAM_TYPE_VOD] = "VIDEO_STREAM_TYPE_VOD";
    $r[$r.VIDEO_STREAM_TYPE_DVR] = "VIDEO_STREAM_TYPE_DVR";
    $r[$r.VIDEO_STREAM_TYPE_LIVE] = "VIDEO_STREAM_TYPE_LIVE";
    $r[$r.VIDEO_STREAM_TYPE_UNSPECIFIED] = "VIDEO_STREAM_TYPE_UNSPECIFIED";
    var as = {
        YT_IDB_TRANSACTION_TYPE_READ: 2,
        YT_IDB_TRANSACTION_TYPE_WRITE: 1,
        YT_IDB_TRANSACTION_TYPE_UNKNOWN: 0
    };
    as[as.YT_IDB_TRANSACTION_TYPE_READ] = "YT_IDB_TRANSACTION_TYPE_READ";
    as[as.YT_IDB_TRANSACTION_TYPE_WRITE] = "YT_IDB_TRANSACTION_TYPE_WRITE";
    as[as.YT_IDB_TRANSACTION_TYPE_UNKNOWN] = "YT_IDB_TRANSACTION_TYPE_UNKNOWN";
    var bs = {
        PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN: 2,
        PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT: 1,
        PLAYER_ROTATION_TYPE_UNKNOWN: 0
    };
    bs[bs.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN] = "PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
    bs[bs.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT] = "PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";
    bs[bs.PLAYER_ROTATION_TYPE_UNKNOWN] = "PLAYER_ROTATION_TYPE_UNKNOWN";
    var cs = "actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo prefetchInfo accelerationSession webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");
    var ds = y.ytLoggingLatencyUsageStats_ || {};
    z("ytLoggingLatencyUsageStats_", ds);
    ...
    es.prototype.tick = function(a, b, c, d) {
        gs(this, "tick_" + a + "_" + b) || (c = {
            timestamp: c,
            cttAuthInfo: d
        }, M("web_csi_via_jspb") ? (d = new Jh, C(d, 1, a), C(d, 2, b), a = new Mh, zd(a, Jh, 5, Nh, d), Hp(a, c)) : lk("latencyActionTicked", {
            tickName: a,
            clientActionNonce: b
        }, c))
    };
    es.prototype.info = function(a, b, c) {
        var d = Object.keys(a).join("");
        gs(this, "info_" + d + "_" + b) || (a = Object.assign({}, a), a.clientActionNonce = b, lk("latencyActionInfo", a, {
            cttAuthInfo: c
        }))
    };
    es.prototype.jspbInfo = function(a, b, c) {
        for (var d = "", e = 0; e < a.toJSON().length; e++) void 0 !== a.toJSON()[e] && (d = 0 === e ? d.concat("" + e) : d.concat("_" + e));
        gs(this, "info_" + d + "_" + b) || (C(a, 2, b), b = {
            cttAuthInfo: c
        }, c = new Mh, zd(c, Dh, 7, Nh, a), Hp(c, b))
    };
    es.prototype.span = function(a, b, c) {
        var d = Object.keys(a).join("");
        gs(this, "span_" + d + "_" + b) || (a.clientActionNonce = b, lk("latencyActionSpan", a, {
            cttAuthInfo: c
        }))
    };
    ...
    function gs(a, b) {
        ...
        a.i || (a.i = Vj(function() {
            var d = P(),
                e;
            for (e in ds) ds[e] && 6E4 < d - ds[e].time && delete ds[e];
            a && (a.i = 0)
        }, 5E3));
    ...
    function hs() {
        ...
        if ("cold" === a.yt_lt || "cold" === b.loadType) {
            ...
            for (var e in c) e in d || js(e, c[e]);
            e = {};
            c = !1;
            d = q(Object.keys(a));
            for (var f = d.next(); !f.done; f = d.next()) f = f.value, (f = Ur(f, a[f])) && !Jr(Gr(), f) && (nr(b, f), nr(e, f), c = !0);
            c && ks(e)
        }
        z("ytglobal.timingready_", !0);
        a = L("TIMING_ACTION");
        A("ytglobal.timingready_") && a && "_start" in zr() &&
            yr() && Ir()
    }

    function ls(a, b, c, d) {
        null !== b && (Er(c)[a] = b, (a = Ur(a, b, c)) && ks(a, c, d))
    }

    function ks(a, b, c) {
        if (!M("web_csi_via_jspb") || (void 0 === c ? 0 : c)) c = Mr(b || ""), nr(c.info, a), nr(Gr(b), a), c = Hr(b), b = Dr(b).cttAuthInfo, fs().info(a, c, b);
        else {
            c = new Dh;
            var d = Object.keys(a);
            a = Object.values(a);
                ...
                try {
                    switch (f) {
                        ...
                        case "getLibraryRequestId":
                            ...
                            break;
                        default:
                            cs.includes(f) && hi(new Q("Codegen laipb translator asked to translate message field", "" + f))
                    }
                } catch (g) {
                    hi(Error("Codegen laipb translator failed to set " + f))
                }
            }
            ms(c, b)
        }
    ...
    function js(a, b, c) {
        if (!b && "_" !== a[0]) {
            var d = a;
            R.mark && (0 == d.lastIndexOf("mark_", 0) || (d = "mark_" + d), c && (d += " (" + c + ")"), R.mark(d))
        }
        Mr(c || "").tick[a] = b || P();
        d = Fr(c);
        ...
        d[a] = e;
        e = Hr(c);
        var f = Dr(c).cttAuthInfo;
        if ("_start" === a) {
            var g = fs();
            gs(g, "baseline_" + e) || (b = {
                timestamp: b,
                cttAuthInfo: f
            }, M("web_csi_via_jspb") ? (f = new Bh, C(f, 1, e), e = new Mh, zd(e, Bh, 6, Nh, f), Hp(e, b)) : lk("latencyActionBaselined", {
                clientActionNonce: e
            }, b))
        } else fs().tick(a, e, b, f);
        Ir(c);
        return d[a]
    }
    ...
    function is() {
        function a(f) {
            ...
            h && (js("srt", g.responseStart), 1 !== f.prerender && js("_start", h, void 0));
            f = Kr();
            0 < f && js("fpt", f);
            f = Ar();
            f.isPerformanceNavigationTiming && ks({
                performanceNavigationTiming: !0
            });
            js("nreqs", f.requestStart, void 0);
            js("nress", f.responseStart, void 0);
            js("nrese", f.responseEnd, void 0);
            0 < f.redirectEnd - f.redirectStart && (js("nrs", f.redirectStart, void 0), js("nre", f.redirectEnd,
                void 0));
            0 < f.domainLookupEnd - f.domainLookupStart && (js("ndnss", f.domainLookupStart, void 0), js("ndnse", f.domainLookupEnd, void 0));
            0 < f.connectEnd - f.connectStart && (js("ntcps", f.connectStart, void 0), js("ntcpe", f.connectEnd, void 0));
            f.secureConnectionStart >= Cr() && 0 < f.connectEnd - f.secureConnectionStart && (js("nstcps", f.secureConnectionStart, void 0), js("ntcpe", f.connectEnd, void 0));
            R && "getEntriesByType" in R && ps()
        }
        var b = L("TIMING_INFO", {});
        if (M("web_csi_via_jspb")) {
            b = qs(b);
            ms(b);
            b = Fh(Gh(new Dh, !0), X[Tr(L("TIMING_ACTION"))]);
            var c = L("PREVIOUS_ACTION");
            c && C(b, 13, X[Tr(c)]);
            (c = L("CLIENT_PROTOCOL")) && C(b, 33, c);
            (c = L("CLIENT_TRANSPORT")) && C(b, 34, c);
            (c = nq()) && "UNDEFINED_CSN" !== c && C(b, 4, c);
            c = os();
            1 !== c && -1 !== c || C(b, 6, !0);
            c = Er();
            C(b, 3, "cold");
            ...
            for (c in b) b.hasOwnProperty(c) && ls(c, b[c]);
            b = {
                isNavigation: !0,
                actionType: Tr(L("TIMING_ACTION"))
            };
            if (c = L("PREVIOUS_ACTION")) b.previousAction = Tr(c);
            if (c = L("CLIENT_PROTOCOL")) b.httpProtocol = c;
            if (c = L("CLIENT_TRANSPORT")) b.transportProtocol = c;
            (c = nq()) && "UNDEFINED_CSN" !== c && (b.clientScreenNonce = c);
            c = os();
    ...
    function ss(a, b) {
        ...
        return c ? (a = R.getEntriesByName(c)) && a[0] && (a = a[0], c = Cr(), js("rsf_" + b, c + Math.round(a.fetchStart)), js("rse_" + b, c + Math.round(a.responseEnd)), void 0 !== a.transferSize && 0 === a.transferSize) ? !0 : !1 : !1
    }

    function rs() {
        var a = [];
        if (document.querySelector && R && R.getEntriesByName)
            for (var b in xr)
                if (xr.hasOwnProperty(b)) {
                    var c = xr[b];
                    ss(b, c) && a.push(c)
                } return a
    }
    ...
    function ps() {
        ...
        (b = gb(b, function(c, d) {
            ...
            duration: 0
        })) && 0 < b.startTime && 0 < b.responseEnd && (js("wffs", Br(b.startTime)), js("wffe", Br(b.responseEnd)))
    }
    var ts = window;
    ts.ytcsi && (ts.ytcsi.info = ls, ts.ytcsi.tick = js);
    var us = "tokens consistency mss client_location entities response_received_commands store".split(" ");
    ...
    function vs(a, b, c, d) {
        ...
        this.i = new Map;
        a.Ba || (a.Ba = {});
        a.Ba = Object.assign({}, mr, a.Ba)
    }

    function ws(a, b, c, d) {
        if (void 0 !== vs.i) {
            if (d = vs.i, a = [a !== d.s, b !== d.J, c !== d.m, !1, !1, void 0 !== d.j], a.some(function(e) {
                    return e
    ...
    function xs(a) {
        ...
        return e ? new Zf(function(f) {
            ...
            return w(function(m) {
                if (1 == m.i) {
                    h = "cors" === (null == (g = e.sa) ? void 0 : g.mode) ? "cors" : void 0;
                    if (a.m.Cc) {
                        var p = e.config,
                            t;
                        p = null == p ? void 0 : null == (t = p.Ia) ? void 0 : t.sessionIndex;
                        t = Nq({
                            sessionIndex: p
                        });
                        k = Object.assign({}, ys(h), t);
                        return m.u(2)
                    }
                    return u(m, zs(e.config,
                        h), 3)
                }
                2 != m.i && (k = m.j);
                f(As(a, e, k));
    ...
    function As(a, b, c) {
        var d, e, f, g, h, k, m, p, t, x, v, D, G, K, N, O, S, ka, V;
        return w(function(W) {
            switch (W.i) {
                case 1:
                    W.u(2);
                ...
                case 2:
                    if (null == (e = b) ? 0 : null == (f = e.Z) ? 0 : f.context)
                        for (g = q([]), h = g.next(); !h.done; h = g.next()) k = h.value, k.zp(b.Z.context);
                    if (null == (m = a.j) ? 0 : m.Ep(b.input, b.Z)) return W.return(a.j.wp(b.input, b.Z));
                    (x = null == (t = b.config) ? void 0 : t.Bp) && a.i.has(x) && M("web_memoize_inflight_requests") ? p = a.i.get(x) : (v = JSON.stringify(b.Z),
                        b.sa = Object.assign({}, b.sa, {
                            headers: c
                        }), D = Object.assign({}, b.sa), "POST" === b.sa.method && (D = Object.assign({}, D, {
                            body: v
                        })), (null == (G = b.config) ? 0 : G.nc) && js(b.config.nc), K = function() {
                            return a.J.fetch(b.input, D, b.config)
                        }, p = K(), x && a.i.set(x, p));
                    return u(W, p, 4);
                case 4:
                    N = W.j;
                    x && a.i.has(x) && a.i.delete(x);
                    (null == (O = b.config) ? 0 : O.oc) && js(b.config.oc);
                    if (N || null == (S = a.j) || !S.rp(b.input, b.Z)) {
                        W.u(5);
                        break
                    }
                    return u(W, a.j.vp(b.input, b.Z), 6);
                case 6:
                    N = W.j;
                case 5:
                    if (N && a.l)
                        for (ka = q(us), h = ka.next(); !h.done; h = ka.next()) V = h.value, a.l[V] && a.l[V].handleResponse(N, b);
                    return W.return(N)
            }
        })
    }
    ...
    function zs(a, b) {
        ...
        return w(function(g) {
            if (1 == g.i) {
                e = null == (c = a) ? void 0 : null == (d = c.Ia) ? void 0 : d.sessionIndex;
                var h = Nq({
                    sessionIndex: e
                });
                if (!(h instanceof Zf)) {
            ...
            f = g.j;
            return g.return(Promise.resolve(Object.assign({}, ys(b), f)))
        })
    }
    ...
    var Bs = ["share/get_web_player_share_panel"],
        Cs = ["feedback"],
        Ds = ["notification/modify_channel_preference"],
        Es = ["browse/edit_playlist"],
        Fs = ["subscription/subscribe"],
        Gs = ["subscription/unsubscribe"];
    ...
    da.Object.defineProperties(Js.prototype, {
        m: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    var Rq = new Pq("NETWORK_SLI_TOKEN");

    function Ns(a) {
        this.i = a
    }
    Ns.prototype.fetch = function(a, b) {
        var c = this,
            d, e;
        return w(function(f) {
            c.i && (d = ac(bc(5, kc(a))) || "/UNKNOWN_PATH", c.i.start(d));
    ...
    Ns.prototype.handleResponse = function(a) {
        ...
        a.redirected || a.ok ? this.i && this.i.success() : (this.i && this.i.failure(), b = b.then(function(c) {
            Wp(new Q("Error: API fetch failed", a.status, a.url, c));
    ...
    Ns[Oq] = [new Qq];
    var Os = new Pq("NETWORK_MANAGER_TOKEN");
    var Ps;
    ...
    r(Qs, Tl);
    var bm = new Ul("screen-created", Qs),
        Rs = [],
        Ts = Ss,
        Us = 0;
    ...
    function Vs(a, b, c, d, e, f, g) {
        function h() {
            Wp(new Q("newScreen() parent element does not have a VE - rootVe", b))
        }
        var k = Ts();
        f = new gq({
            veType: b,
        ...
        if (M("il_via_jspb")) {
            ...
            m.P(k);
            rh(m, f.getAsJspb());
            c && c.visualElement ? (f = new sh, c.clientScreenNonce && C(f, 2, c.clientScreenNonce), th(f, c.visualElement.getAsJspb()), g && C(f, 4, Oh[g]), E(m, sh, 5, f)) : c && h();
            d && C(m, 3, d);
            Mp(m, e, a)
        } else f = {
                csn: k,
            ...
            c && h(), d && (f.cloneCsn = d), a ? qp("screenCreated", f, a, e) : lk("screenCreated", f, e);
        Zl(bm, new Qs(k));
        return k
    }
    ...
    function Ws(a, b, c, d) {
        ...
        d = q(d);
        for (var g = d.next(); !g.done; g = d.next()) g = g.value.getAsJson(), (nb(g) || !g.trackingParams && !g.veType) && Wp(Error("Child VE logged with no data"));
        if (M("il_via_jspb")) {
            var h = new uh;
            h.P(b);
            wh(h, c.getAsJspb());
            ...
            "UNDEFINED_CSN" == b ? Xs("visualElementAttached", h, f) : Np(h, f, a)
        } else c = {
            csn: b,
            parentVe: c.getAsJson(),
            childVes: fb(e, function(k) {
                return k.getAsJson()
            })
        }, "UNDEFINED_CSN" == b ? Xs("visualElementAttached", c, f) : a ? qp("visualElementAttached", c, a, f) : lk("visualElementAttached", c, f)
    }
    ...
    function dm(a) {
        if (Rs) {
            for (var b = q(Rs), c = b.next(); !c.done; c = b.next())
                if (c = c.value, c.payload)
                    if (M("il_via_jspb")) switch (c.payload.P(a.csn), c.payloadName) {
                        case "screenCreated":
                            Mp(c.payload, c.options);
                            break;
                        case "visualElementAttached":
                            Np(c.payload, c.options);
                            break;
                        ...
                        case "visualElementStateChanged":
                            Lp(c.payload, c.options);
                            break;
                        default:
                            Wp(new Q("flushQueue unable to map payloadName to JSPB setter"))
                    } else c.payload.csn =
                        a.csn, qp(c.payloadName, c.payload, null, c.options);
            Rs.length = 0
        }
        Us = 0
    };
    ...
    function $s(a, b, c) {
        ...
        b.then(function(d) {
            ...
            if (e && f) {
                var g;
                (null == d ? 0 : null == (g = d.response) ? 0 : g.trackingParams) && Ws(a.client, e, f, [hq(d.response.trackingParams)]);
                var h;
                (null == d ? 0 : null == (h = d.playerResponse) ? 0 : h.trackingParams) && Ws(a.client, e, f, [hq(d.playerResponse.trackingParams)])
            }
        })
    }
    ...
    function at(a, b, c, d) {
        ...
        if (a.j.has(d)) a.s.push([b, c]);
            ...
            var e = nq(d);
            c = c || lq(d);
            e && c && Ws(a.client, e, c, [b])
        }
    }
    Zs.prototype.clickCommand = function(a, b, c) {
        var d = a.clickTrackingParams;
        c = void 0 === c ? 0 : c;
        if (d)
            if (c = nq(void 0 === c ? 0 : c)) {
                a = this.client;
                var e = hq(d);
                ...
                if (M("il_via_jspb")) {
                    ...
                    C(g, 4, Oh[f]);
                    b && E(g, oh, 3);
                    "UNDEFINED_CSN" == c ? Xs("visualElementGestured", g, d) : Kp(g, d, a)
                } else f = {
                    csn: c,
                    ve: e.getAsJson(),
                    gestureType: f
                }, b && (f.clientData = b), "UNDEFINED_CSN" == c ? Xs("visualElementGestured", f, d) : a ? qp("visualElementGestured",
                    f, a, d) : lk("visualElementGestured", f, d);
                b = !0
            } else b = !1;
        else b = !1;
        return b
    ...
    function bt(a, b, c) {
        ...
        a.l = function() {
            ...
            var f = lq(c.layer);
            if (f) {
                for (var g = q(a.s), h = g.next(); !h.done; h = g.next()) h = h.value, at(a, h[0], h[1] || f, c.layer);
                f = q(a.D);
                for (g = f.next(); !g.done; g = f.next()) {
                    ...
                    if (h && m) {
                        ...
                        M("il_via_jspb") ? (p = new Ah, p.P(h), m = m.getAsJspb(), E(p, lh, 2, m), "UNDEFINED_CSN" == h ? Xs("visualElementStateChanged", p, k) : Lp(p, k, g)) : (m = {
                            csn: h,
                            ve: m.getAsJson(),
                            clientData: p
                        }, "UNDEFINED_CSN" == h ? Xs("visualElementStateChanged", m, k) : g ? qp("visualElementStateChanged", m, g, k) : lk("visualElementStateChanged", m, k))
                    }
                }
            }
        };
        nq(c.layer) || a.l();
        if (c.ub)
            for (var d = q(c.ub), e = d.next(); !e.done; e = d.next()) $s(a, e.value, c.layer);
        else Vp(Error("Delayed screen needs a data promise."))
    }

    function ct(a, b, c) {
        c = void 0 === c ? {} : c;
        c.layer || (c.layer = 0);
        var d = void 0 !== c.ic ? c.ic : c.layer;
        var e = nq(d);
        d = lq(d);
        var f;
        ...
        try {
            var k = Vs(a.client, b, f, c.tb, c.cttAuthInfo, g, c.up)
        } catch (m) {
            Yp(m, {
                Cp: b,
                rootVe: d,
        ...
        b && (b = a.client, g = !0, h = (g = void 0 === g ? !1 : g) ? 16 : 8, f = {
            ...
            V: e,
            wb: g
        }, M("il_via_jspb") ? (h = new zh, h.P(e), d = d.getAsJspb(), E(h, lh, 2, d), C(h, 4, g ? 16 : 8), "UNDEFINED_CSN" == e ? Xs("visualElementHidden", h, f) : Jp(h, f, b)) : (d = {
            csn: e,
            ve: d.getAsJson(),
            eventType: h
        }, "UNDEFINED_CSN" == e ? Xs("visualElementHidden", d, f) : b ? qp("visualElementHidden", d, b, f) : lk("visualElementHidden",
            d, f)));
        ...
        e && "UNDEFINED_CSN" !== e && d && (M("web_mark_root_visible") || M("music_web_mark_root_visible")) && (e = k, k = {
            cttAuthInfo: pq(e),
            V: e
        }, M("il_via_jspb") ? (b = new zh, b.P(e), f = d.getAsJspb(), E(b, lh, 2, f), C(b, 4, 1), "UNDEFINED_CSN" == e ? Xs("visualElementShown", b, k) : Ip(b, k)) : (b = {
            csn: e,
            ve: d.getAsJson(),
            eventType: 1
        }, "UNDEFINED_CSN" == e ? Xs("visualElementShown", b, k) : lk("visualElementShown",
            b, k)));
        a.j.delete(c.layer || 0);
        a.l = void 0;
        e = q(a.v);
        for (k = e.next(); !k.done; k = e.next()) b = q(k.value), k = b.next().value, b = b.next().value, b.has(c.layer) && d && at(a, k, d, c.layer);
    ...
    function dt() {
        var a, b;
        return w(function(c) {
            if (1 == c.i) return a = vs.i, a ? u(c, xs(a), 2) : (Wp(Error("InnertubeTransportService unavailable in fetchDatasyncIds")), c.return(void 0));
            if (b = c.j) return b.errorMetadata ? (Wp(Error("Datasync IDs fetch responded with " + b.errorMetadata.status + ": " + b.error)), c.return(void 0)) : c.return(b.tp);
            Wp(Error("Network request to get Datasync IDs failed."));
    ...
    function ht() {
        return w(function(a) {
            if (void 0 !== ft) return a.return(ft);
            ft = new Promise(function(b) {
                var c;
                return w(function(d) {
                    switch (d.i) {
                        case 1:
                            return wa(d, 2), u(d, et.open("test-only"), 4);
                        case 4:
                            return u(d, et.delete("test-only"), 5);
                        case 5:
                            xa(d, 3);
                            break;
                        case 2:
    ...
    function jt(a) {
        var b, c, d, e, f, g, h;
        w(function(k) {
            if (1 == k.i) return u(k, ht(), 2);
            if (3 != k.i) {
                if (!k.j) return k.return(!1);
                b = [];
                return u(k, et.keys(), 3)
            }
            c = k.j;
            d = q(c);
            for (e = d.next(); !e.done; e = d.next()) f = e.value, g = gt(f), h = g.datasyncId, !h || a.includes(h) || b.push(et.delete(f));
    ...
    function kt() {
        var a, b, c, d, e, f, g;
        return w(function(h) {
            if (1 == h.i) return u(h, ht(), 2);
            if (3 != h.i) {
                if (!h.j) return h.return(!1);
                a = pk("cache contains other");
                return u(h, et.keys(), 3)
            }
            b = h.j;
            c = q(b);
            for (d = c.next(); !d.done; d = c.next())
                if (e = d.value, f = gt(e), (g = f.datasyncId) && g !== a) return h.return(!0);
            return h.return(!1)
        })
    };
    ...
    function ot() {
        ...
        b = q(b);
        for (var c = b.next(); !c.done; c = b.next())
            if (c = mt(c.value), void 0 !== c && c !== a) return !0;
        return !1
    };
            ...
            return w(function(f) {
                switch (f.i) {
                    case 1:
                        ...
                        return u(f, kt(), 3);
                    case 3:
                        return d = f.j, u(f, Bl(), 4);
                    case 4:
                        if (e = f.j, !c && !d && !e) return f.return();
                    case 2:
                        a.H() ? pt() : a.m.add("publicytnetworkstatus-online", pt, !0, void 0, void 0), f.i = 0
                }
            })
        })
    };
    ...
    function rt(a) {
        a && (a.dataset ? a.dataset[st("loaded")] = "true" : a.setAttribute("data-loaded", "true"))
    }

    function tt(a, b) {
        return a ? a.dataset ? a.dataset[st(b)] : a.getAttribute("data-" + b) : null
    }
    var ut = {};

    function st(a) {
        return ut[a] || (ut[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
        ...
        if (window.spf && spf.script) {
            ...
            if (a) {
                var d = a.indexOf("jsbin/"),
                    e = a.lastIndexOf(".js"),
                    f = d + 6; - 1 < d && -1 < e && e > f && (c = a.substring(f, e), c = c.replace(vt, ""), c = c.replace(wt, ""), c = c.replace("debug-", ""), c = c.replace("tracing-", ""))
            }
    ...
    function zt(a, b, c) {
        ...
        var d = At(a),
            ...
            f = e && tt(e, "loaded"),
            g = e && !f;
        f ? b && b() : (b && (f = Pn(d, b), b = "" + Qa(b), Bt[b] = f), g || (e = Ct(a, d, function() {
            tt(e, "loaded") || (rt(e), Sn(d), Bi(Wa(Tn, d), 0))
        }, c)))
    }
    ...
    function Dt(a) {
        ...
        b && (Tn(a), b.parentNode.removeChild(b))
    }

    function Et(a, b) {
        a && b && (a = "" + Qa(b), (a = Bt[a]) && Rn(a))
    }
    ...
    function Ht() {
        if (!M("disable_biscotti_fetch_for_ad_blocker_detection") && !M("disable_biscotti_fetch_entirely_for_all_web_clients") && Cq()) {
            var a = L("PLAYER_VARS", {});
            if (!("1" == pb(a) || M("embeds_web_disable_ads_for_pfl") && Dq(a))) {
                var b = function() {
                    Gt = !0;
                ...
                Ft.push(gf.M(function() {
                    if (!(Gt || "google_ad_status" in window)) {
                        try {
                            Et("//static.doubleclick.net/instream/ad_status.js", b)
                        } catch (c) {}
                        Gt = !0;
                        Zh("DCLKSTAT", 3)
                    }
    ...
    Lt.prototype.initialize = function(a, b, c) {
        if (a.program) {
            var d, e = null != (d = a.interpreterScript) ? d : null,
                f;
            d = null != (f = a.interpreterUrl) ? f : null;
            a.interpreterSafeScript && (e = a.interpreterSafeScript, Bb("From proto message. b/166824318"), e = e.privateDoNotAccessOrElseSafeScriptWrappedValue || "", e = (f = yb()) ? f.createScript(e) : e, e = (new Db(e)).toString());
            a.interpreterSafeUrl && (d = a.interpreterSafeUrl, Bb("From proto message. b/166824318"), d = Hb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue || "").toString());
            Mt(this, e, d, a.program, b, c)
        } else Wp(Error("Cannot initialize botguard without program"))
    };

    function Mt(a, b, c, d, e, f) {
        var g = void 0 === g ? "trayride" : g;
        c ? (a.state = 2, xt(c, function() {
            window[g] ? Nt(a, d, g, e) : (a.state = 3, Dt(c), Wp(new Q("Unable to load Botguard", "from " + c)))
        }, f)) : b ? (f = Rd("SCRIPT"), f.textContent = b, f.nonce = Xb(), document.head.appendChild(f), document.head.removeChild(f), window[g] ? Nt(a, d, g, e) : (a.state = 4, Wp(new Q("Unable to load Botguard from JS")))) : Wp(new Q("Unable to load VM; no url or JS provided"))
    }
    Lt.prototype.isInitialized = function() {
        return !!this.i
    };
    ...
    function Nt(a, b, c, d) {
        ...
        try {
            ...
            a.state = 7, f instanceof Error && Wp(f)
        }
    }
    Lt.prototype.invoke = function(a) {
        a = void 0 === a ? {} : a;
        if (this.i) {
            var b = this.i;
            a = {
    ...
    function St(a) {
        ...
        for (d = c.next(); !d.done; a = {
            ...
            e = Wj(d, Tt(this, a.ta));
            this.i[a.Da] = Object.assign({}, a.ta, {
                gb: d,
                Pa: e
            })
        }
    ...
    function Ut(a) {
        var b = Array.from(a.i.keys()).sort(function(d, e) {
            return Tt(a, a.i[e]) - Tt(a, a.i[d])
        });
        b = q(b);
        for (var c = b.next(); !c.done; c = b.next()) c = a.i[c.value], void 0 === c.Pa || c.Ta || (a.l.S(c.Pa), Wj(c.gb, 10))
    }
    St.prototype.cancel = function() {
        for (var a = q(this.i), b = a.next(); !b.done; b = a.next()) b = b.value, void 0 === b.Pa || b.Ta || this.l.S(b.Pa), b.Ta = !0;
        this.j.resolve()
    };
    ...
    Vt.prototype.install = function() {
        this.plugins.push.apply(this.plugins, fa(Ia.apply(0, arguments)))
    };
    Vt.prototype.transition = function(a, b) {
        var c = this,
            d = this.D.find(function(f) {
                return f.from === c.state && f.B === a
            });
        if (d) {
            this.l && (Ut(this.l), this.l = void 0);
            this.state = a;
    ...
    function Wt(a, b, c) {
        return function() {
            ...
            for (var h = e.next(); !h.done; g = {
                    Ea: g.Ea
                }, h = e.next()) g.Ea = h.value, Yj(function(k) {
                return function() {
                    k.Ea.ka.apply(k.Ea, fa(d))
                }
            }(g));
            f = f.map(function(k) {
                var m;
    ...
    function Xt(a) {
        Vt.call(this, void 0 === a ? "document_active" : a);
        var b = this;
        this.o = 10;
        this.i = new Map;
        this.D = [{
    ...
    function Yt(a) {
        Vt.call(this, void 0 === a ? "document_visibility_unknown" : a);
        var b = this;
        this.D = [{
    ...
    $t.prototype.m = function() {
        if (M("web_fp_via_jspb")) {
            ...
            zd(b, kh, 380, Nh, a);
            Hp(b);
            M("web_fp_via_jspb_and_json") && lk("finalPayload", {
                csn: nq()
            })
        } else lk("finalPayload", {
            csn: nq()
        })
    };
    ...
    function bu() {}
    bu.getInstance = function() {
        var a = A("ytglobal.storage_");
        a || (a = new bu, z("ytglobal.storage_", a));
        return a
    };
    bu.prototype.estimate = function() {
        var a, b, c;
        return w(function(d) {
            a = navigator;
            return (null == (b = a.storage) ? 0 : b.estimate) ? d.return(a.storage.estimate()) : (null == (c = a.webkitTemporaryStorage) ? 0 : c.queryUsageAndQuota) ? d.return(cu()) : d.return()
        })
    };
    ...
    jk.prototype.logEvent = function(a, b) {
        switch (a) {
    ...
    function du(a, b) {
        bu.getInstance().estimate().then(function(c) {
            c = Object.assign({}, b, {
                isSw: void 0 === self.document,
                isIframe: self !== self.top,
                deviceStorageUsageMbytes: eu(null == c ? void 0 : c.usage),
                deviceStorageQuotaMbytes: eu(null == c ? void 0 : c.quota)
            });
            ...
            a: if (!("*" != d.m && e.origin != d.m || d.l && e.source != d.l || "string" !== typeof e.data)) {
                ...
                if (!(null == f || d.L && (d.sessionId && d.sessionId != f.id || d.channel && d.channel != f.channel)) && f) switch (f.event) {
                    case "listening":
                        ...
                        break;
                    case "command":
                        d.o && (!d.v || 0 <= cb(d.v, f.func)) && d.o(f.func, f.args, e.origin)
                }
            }
        };
    ...
    r(fu, I);
    fu.prototype.sendMessage = function(a, b) {
        if (b = b || this.l) {
    ...
    function gu() {
        ...
        this.isReady = !1;
        this.l = {};
        var a = this.i = new fu(!!L("WIDGET_ID_ENFORCE")),
            b = this.lc.bind(this);
        a.o = b;
        a.v = null;
    ...
    l = gu.prototype;
    l.lc = function(a, b, c) {
        "addEventListener" === a && b ? (a = b[0], this.l[a] || "onReady" === a || (this.addEventListener(a, hu(this, a)), this.l[a] = !0)) : this.nb(a, b, c)
    };
    l.nb = function() {};
    ...
    l.Yb = function() {
        this.isReady = !0;
        this.sendMessage("initialDelivery", this.ab());
        this.sendMessage("onReady");
        db(this.j, this.Lb, this);
        this.j = []
    };
    l.ab = function() {
        return null
        ...
        if (this.api.isExternalMethodAvailable(a, c)) {
            ...
            if (0 < b.length && ju(a)) {
                ...
                if (Oa(d[0]) && !Array.isArray(d[0])) var e = d[0];
                    ...
                    case "loadVideoById":
                    case "cueVideoById":
                        e = ku(d[0], void 0 !== d[1] ? Number(d[1]) : void 0, d[2]);
                        break;
                    case "loadVideoByUrl":
                    case "cueVideoByUrl":
                        e = d[0];
                    ...
                    case "loadPlaylist":
                    case "cuePlaylist":
                        e = lu(d[0], d[1], d[2], d[3])
                }
                b.length = 1;
                b[0] = e
            }
            this.api.handleExternalCall(a, b, c);
            ju(a) && iu(this, this.ab())
        }
    };
    l.onReady = function() {
        var a = this.Yb.bind(this);
        this.i.j = a
    };
    ...
    l.dispose = function() {
        gu.prototype.dispose.call(this);
    ...
    function nu(a) {
        ...
        this.started = !1;
        this.connection = a;
        this.connection.subscribe("command", this.Hb, this)
    }
    r(nu, I);
    l = nu.prototype;
    l.start = function() {
        this.started || this.i() || (this.started = !0, this.connection.ma("RECEIVING"))
    };
    l.ma = function(a, b) {
        this.started && !this.i() && this.connection.ma(a, b)
    };
    l.Hb = function(a, b, c) {
        if (this.started && !this.i()) {
            ...
            switch (a) {
                ...
                case "removeEventListener":
                    ...
                    break;
                default:
                    this.api.isReady() && this.api.isExternalMethodAvailable(a, c || null) && (b = ou(a, b || {}), c = this.api.handleExternalCall(a, b, c || null), (c = pu(a, c)) && this.ma(a, c))
            }
        }
    };
    ...
    l.qc = function(a, b) {
        this.started && !this.i() && this.connection.ma(a, this.Za(a, b))
    };
    l.Za = function(a, b) {
        if (null != b) return {
            value: b
    ...
    l.I = function() {
        ...
        a.i() || sg(a.j, "command", this.Hb, this);
    ...
    r(qu, nu);
    qu.prototype.addEventListener = function(a, b) {
        this.api.addEventListener(a, b)
    };
    qu.prototype.removeEventListener = function(a, b) {
    ...
    qu.prototype.Za = function(a, b) {
        ...
        return nu.prototype.Za.call(this, a, b)
    };
    qu.prototype.I = function() {
        nu.prototype.I.call(this);
        delete this.api
    };
    ...
    function ru(a) {
        ...
        I.call(this);
        this.j = new J(a);
        we(this, Wa(ue, this.j))
    }
    Xa(ru, I);
    ru.prototype.subscribe = function(a, b, c) {
        return this.i() ? 0 : this.j.subscribe(a, b, c)
    };
    ru.prototype.m = function(a, b) {
        this.i() || this.j.ia.apply(this.j, arguments)
    };
    ...
    r(su, ru);
    su.prototype.ma = function(a, b) {
        this.i() || this.l.ma(this.destination, this.id, a, b)
    };
    su.prototype.I = function() {
        this.destination = this.l = null;
        ru.prototype.I.call(this)
    };
    ...
    function tu(a, b, c) {
        ...
        this.destination = a;
        this.origin = c;
        this.j = Cn(window, "message", this.l.bind(this));
        this.connection = new su(this, a, b);
        we(this, Wa(ue, this.connection))
    }
    r(tu, I);
    tu.prototype.ma = function(a, b, c, d) {
        this.i() || a !== this.destination || (a = {
            id: b,
            command: c
        }, d && (a.data = d), this.destination.postMessage(Tf(a), this.origin))
    };
    ...
    var vu = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;
    ...
    function xu(a) {
        var b = yu(a),
            ...
            d = c && tt(c, "loaded");
        d || c && !d || (c = zu(a, b, function() {
            tt(c, "loaded") || (rt(c), Sn(b), Bi(Wa(Tn, b), 0))
        }))
    }
    ...
    function yu(a) {
        var b = Rd("A");
        Bb("This URL is never added to the DOM");
        Ub(b, new Jb(a, Kb));
        a = b.href.replace(/^[a-zA-Z]+:\/\//, "//");
        return "css-" + Zb(a)
    };
    ...
    function Cu(a, b, c, d) {
        ...
        this.R = new J;
        this.j = {};
        this.ea = this.Ga = this.elementId = this.Wa = this.config = null;
        this.W = !1;
        this.m = this.L = null;
        this.Ha = {};
        this.Pb = ["onReady"];
        ...
        this.oa = 0;
        this.l = this.o = a;
        we(this, Wa(ue, this.R));
        Du(this);
        Eu(this);
        we(this, Wa(ue, this.Qb));
        c ? this.oa = Bi(function() {
    ...
    l.loadNewVideoConfig = function(a) {
        if (!this.i()) {
            this.oa && (Ci(this.oa), this.oa = 0);
            var b = a || {};
            b instanceof uu || (b = new uu(b));
            this.config = b;
            this.setConfig(a);
            Gu(this);
            this.isReady() && Hu(this)
        }
    };
    ...
    l.setConfig = function(a) {
        ...
        if (!this.Ga) {
            var b;
            this.Ga = Ju(this, (null == (b = this.config.args) ? void 0 : b.jsapicallback) || "onYouTubePlayerReady")
        }
        this.config.args ? this.config.args.jsapicallback = null : this.config.args = {
            jsapicallback: null
        };
        var c;
        if (null == (c = this.config) ? 0 : c.attrs) a = this.config.attrs, (b = a.width) && this.l && (this.l.style.width = be(Number(b) || b)), (a = a.height) && this.l && (this.l.style.height = be(Number(a) || a))
    };
    ...
    function Ku(a) {
        var b = !0,
            c = Lu(a);
        c && a.config && (a = Mu(a), b = tt(c, "version") === a);
    ...
    function Gu(a) {
        if (!a.i() && !a.W) {
            var b = Ku(a);
            if (b && "html5" === (Lu(a) ? "html5" : null)) a.ea = "html5", a.isReady() || Nu(a);
            else if (Ou(a), a.ea = "html5", b && a.m && a.o) a.o.appendChild(a.m), Nu(a);
            else {
                a.config && (a.config.loaded = !0);
                var c = !1;
                a.L = function() {
                    c = !0;
                    var d = Pu(a, "player_bootstrap_method") ? A("yt.player.Application.createAlternate") || A("yt.player.Application.create") : A("yt.player.Application.create");
                    var e = a.config ? Iu(a.config) : void 0;
                    d && d(a.o, e, a.webPlayerContextConfig);
                    Nu(a)
                };
                a.W = !0;
                b ? a.L() : (xt(Mu(a), a.L), (b = Qu(a)) && wu(b), Ru(a) && !c && z("yt.player.Application.create", null))
            }
        }
    }

    function Lu(a) {
        var b = Qd(a.elementId);
    ...
    function Su(a) {
        ...
        var b = Lu(a);
        if (b) {
            a.v = Tu(a, b, "addEventListener");
            a.Fa = Tu(a, b, "removeEventListener");
    ...
    function Tu(a, b, c) {
        ...
        return function() {
            ...
            try {
                ...
                "sendAbandonmentPing" !== c && (f.params = c, a.lastError = f, Wp(f))
            }
        }
    }
    ...
    function Du(a) {
        a.Va = !1;
        if (a.Fa)
            for (var b in a.j) a.j.hasOwnProperty(b) && a.Fa(b, a.j[b]);
        for (var c in a.N) a.N.hasOwnProperty(c) && Ci(Number(c));
        a.N = {};
        a.v = null;
        a.Fa = null;
        b = a.api;
    ...
    function Eu(a) {
        a.addEventListener("WATCH_LATER_VIDEO_ADDED", function(b) {
            Sn("WATCH_LATER_VIDEO_ADDED", b)
        });
        a.addEventListener("WATCH_LATER_VIDEO_REMOVED", function(b) {
            Sn("WATCH_LATER_VIDEO_REMOVED", b)
        })
    }
    l.addEventListener = function(a, b) {
        var c = this,
            d = Ju(this, b);
        d && (0 <= cb(this.Pb, a) || this.j[a] || (b = Uu(this, a), this.v && this.v(a, b)), this.R.subscribe(a, d), "onReady" === a && this.isReady() && Bi(function() {
            d(c.api)
        }, 0))
    };
    l.removeEventListener = function(a, b) {
        this.i() || (b = Ju(this, b)) && sg(this.R, a, b)
    };
    ...
    function Uu(a, b) {
        ...
        y[c] = function(d) {
            var e = Bi(function() {
                if (!a.i()) {
                    try {
                        a.R.ia(b, null != d ? d : void 0)
                    } catch (h) {
                        Wp(new Q("PlayerProxy error when creating global callback", {
                            error: h,
                            event: b,
                            playerId: a.A,
                            data: d
    ...
    l.getPlayerType = function() {
        return this.ea || (Lu(this) ? "html5" : null)
    };
    ...
    function Ou(a) {
        ...
        var b = Lu(a);
        b && (Ku(a) || !Ru(a) ? a.m = b : (b && b.destroy && b.destroy(), a.m = null));
        if (a.o)
            for (a = a.o; b = a.firstChild;) a.removeChild(b)
    }
    l.cancel = function() {
        this.L && Et(Mu(this), this.L);
        Ci(this.ob);
        this.W = !1
    };
    l.I = function() {
    ...
    var Vu = {},
        Wu = "player_uid_" + (1E9 * Math.random() >>> 0);

    function Xu(a, b, c) {
        var d = "player";
        c = void 0 === c ? !0 : c;
        d = "string" === typeof d ? Qd(d) : d;
        var e = Wu + "_" + Qa(d),
            f = Vu[e];
        if (f && c) return Yu(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api;
        f = new Cu(d, e, a, b);
        Vu[e] = f;
        Sn("player-added", f.api);
        we(f, function() {
            delete Vu[f.getId()]
        });
        return f.api
    ...
    function dv(a, b, c) {
        ...
        if (b) {
            ...
            g && f.push(g);
            g = cc(d);
            if (0 <= cb(f, g) || !g && 0 == d.lastIndexOf("/", 0))
        ...
        if ((window.ytspf || {}).enabled) spf.navigate(a);
            ...
            a: {
                ...
                for (k = 0; k < t.length; ++k)
                    if (m = t[k], m instanceof Zd && m.isValid(a)) {
                        t = new Jb(a, Kb);
                        break a
                    } t = void 0
            }
    ...
    z("writeEmbed", function() {
        ...
        M("embeds_js_api_set_1p_cookie") && (c = ti(window.location.href), c.embedsTokenValue && (a.args.embedsTokenValue = c.embedsTokenValue));
        hs();
        if ((c = L("WEB_PLAYER_CONTEXT_CONFIGS")) &&
            ...
            if (!c.serializedForcedExperimentIds) {
                var d = ti(window.location.href);
                d.forced_experiments && (c.serializedForcedExperimentIds = d.forced_experiments)
            }
            Zu = Xu(a, c, !1)
        } else Zu = Xu(a);
        Zu.addEventListener("onVideoDataChange", bv);
        a = L("POST_MESSAGE_ID", "player");
        L("ENABLE_JS_API") ? av = new mu(Zu) : L("ENABLE_POST_API") && "string" === typeof a && "string" === typeof b && ($u = new tu(window.parent, a, b), av = new qu(Zu, $u.connection));
        Ht();
        M("ytidb_create_logger_embed_killswitch") || ik();
        a = {};
        au || (au = new $t);
        au.install((a.flush_logs = {
            ka: function() {
                Yo()
            }
        }, a));
        M("embeds_web_enable_new_nwl") ? Vm() : cn();
        M("ytidb_clear_embedded_player") && gf.M(function() {
            var e;
            if (!Ps) {
                Vq || (Vq = new Sq);
                var f = Vq;
                ...
                f.providers.set(g.kc, g);
                g = {
                    rb: {
                        feedbackEndpoint: fr(Js),
                        modifyChannelNotificationPreferenceEndpoint: fr(Ks),
                        playlistEditEndpoint: fr(Ls),
                        subscribeEndpoint: fr(Hs),
                        unsubscribeEndpoint: fr(Is),
                        webPlayerShareEntityServiceEndpoint: fr(Ms)
                    }
                };
                var h = M("web_enable_client_location_service") ? br.getInstance() : void 0,
                    k = {};
    ...
    var ev = gi(function() {
            ...
            if (document.body && Gf(document.body, "exp-invert-logo"))
                if (c && !Gf(document.body, "inverted-hdpi")) {
                    var d = document.body;
                    if (d.classList) d.classList.add("inverted-hdpi");
                    else if (!Gf(d, "inverted-hdpi")) {
                        var e = Ef(d);
                        Ff(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi"))
                    }
                } else !c && Gf(document.body, "inverted-hdpi") && Hf();
            if (b != c) {
                b = "f" + (Math.floor(119 / 31) + 1);
                d = $i(b) || 0;
                d = c ? d | 67108864 : d & -67108865;
                0 == d ? delete Vi[b] : (c = d.toString(16),
                    Vi[b] = c.toString());
                c = !0;
                M("web_secure_pref_cookie_killswitch") && (c = !1);
                b = a.i;
                d = [];
                for (var f in Vi) d.push(f + "=" + encodeURIComponent(String(Vi[f])));
                Si(b, d.join("&"), 63072E3, a.j, c)
            }
            Zs.i || (Zs.i = new Zs);
            a = Zs.i;
            f = 16623;
            var g = void 0 === g ? {} : g;
            Object.values(tq).includes(f) || (Wp(new Q("createClientScreen() called with a non-page VE", f)), f = 83769);
            ...
            a.s = [];
            a.D = [];
            g.ub ? bt(a, f, g) : ct(a, f, g)
        }),
        fv = gi(function() {
            Zu && Zu.sendAbandonmentPing && Zu.sendAbandonmentPing();
            L("PL_ATT") && Pt.dispose();
            for (var a = gf, b = 0, c = Ft.length; b < c; b++) a.S(Ft[b]);
            Ft.length = 0;
            Dt("//static.doubleclick.net/instream/ad_status.js");
            Gt = !1;
            Zh("DCLKSTAT", 0);
            ve(av, $u);
            Zu && (Zu.removeEventListener("onVideoDataChange", bv), Zu.destroy())
        });
    window.addEventListener ? (window.addEventListener("load", ev), window.addEventListener("pagehide", fv)) : window.attachEvent && (window.attachEvent("onload", ev), window.attachEvent("onunload", fv));
    z("yt.abuse.player.botguardInitialized", A("yt.abuse.player.botguardInitialized") || Qt);
    z("yt.abuse.player.invokeBotguard", A("yt.abuse.player.invokeBotguard") || Rt);
    z("yt.abuse.dclkstatus.checkDclkStatus", A("yt.abuse.dclkstatus.checkDclkStatus") || Kt);
    z("yt.player.exports.navigate", A("yt.player.exports.navigate") || dv);
    z("yt.util.activity.init", A("yt.util.activity.init") || Hn);
    z("yt.util.activity.getTimeSinceActive", A("yt.util.activity.getTimeSinceActive") || Kn);
    z("yt.util.activity.setTimestamp", A("yt.util.activity.setTimestamp") || In);
}).call(this);