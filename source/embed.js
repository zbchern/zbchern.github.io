(function(g) {
    ...
    var CXa = function(a, b) {
            ...
            for (k = 0; 1E-6 < Math.abs(f - b) && 8 > k; k++) f < b ? (d = c, c = (c + e) / 2) : (e = c, c = (c + d) / 2), f = g.yo(a, c);
            return c
        },
        s2 = function() {
            return {
        ...
        t2 = function(a) {
            g.G.call(this);
            this.callback = a;
            this.u = new g.xo(0, 0, .4, 0, .2, 1, 1, 1);
        ...
        u2 = function(a) {
            ...
            this.previous.La("click", this.yU, this);
            g.I(this, this.N);
            for (var c = {
                    wt: 0
                }; 16 > c.wt; c = {
                ...
                g.bl(e, "transitionDelay", c.wt / 20 + "s");
                this.C.P(e,
                    "click",
                    function(f) {
                        return function(k) {
                            var l = b.suggestionData[f.wt],
                                m = l.sessionData;
                            g.xJ(k, b.api, b.J, m || void 0) && b.api.wl(l.videoId, m, l.playlistId)
                        }
                    }(c));
                this.B.push(d)
            }
            ...
            this.next.La("click", this.xU, this);
        ...
        DXa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                if (g.aB(k)) {
                    var l = {};
                    k.ma && g.pI(l, k.loaderUrl);
                    f = g.Sh(f, g.oI(l, "emb_rel_err"))
                }
                d.element.style.display = "";
                k = d.ya("ytp-suggestion-title");
                g.vo.test(c.title) ? k.dir = "rtl" : g.USa.test(c.title) && (k.dir = "ltr");
                k = d.ya("ytp-suggestion-author");
                g.vo.test(e) ? k.dir = "rtl" : g.USa.test(e) && (k.dir = "ltr");
                d.update({
                    views_or_author: e,
                    duration: c.isLivePlayback ? "Live" : c.lengthSeconds ? g.xH(c.lengthSeconds) : "",
                    link: f,
                    hover_title: c.title,
                    title: c.title,
        ...
        w2 = function(a) {
            ...
            c.xa(this.element);
            g.I(this, c);
            a.S().C || (this.j = new u2(a), this.j.xa(this.element), g.I(this, this.j));
        ...
        GXa = function(a, b) {
            var c;
            b.reason && (x2(b.reason) ? c = g.Tv(b.reason) : c = g.DJ(g.Sv(b.reason)), a.Ld(c, "content"));
            var d;
            b.subreason && (x2(b.subreason) ? d = g.Tv(b.subreason) : d = g.DJ(g.Sv(b.subreason)), a.Ld(d, "subreason"));
            if (b.proceedButton && b.proceedButton.buttonRenderer && (c = a.ya("ytp-error-content-wrap-subreason"), d = b.proceedButton.buttonRenderer, b = g.Gg("A"), d.text && d.text.simpleText)) {
                var e = d.text.simpleText;
                b.textContent = e;
                a: {
                    for (var f = g.yg("A", c), k = 0; k < f.length; k++)
                ...
                if (!e) {
                    ...
                    e && (a = a.api.S(), a.ma && (e = EXa(e, a.loaderUrl)), b.setAttribute("href", e));
        ...
        y2 = function(a, b) {
            ...
            this.P(this.api, "presentingplayerstatechange", this.eh);
        ...
        HXa = function(a) {
            var b = {};
            a.api.S().ma && g.pI(b, a.api.S().loaderUrl);
            return g.Sh(a.api.getVideoUrl(), g.oI(b, "emb_imp_woyt"))
        },
        z2 = function(a) {
            g.V.call(this, {
                F: "div",
        ...
        C2 = function(a, b) {
            ...
            this.api = a;
            this.I = b;
            this.j = new g.mz(this);
            this.C = new g.jH(this, 1E3, !1, 100);
            this.B = [];
            this.suggestionData = [];
            this.containerWidth = 0;
            this.D = !1;
            ...
            g.I(this, this.previous);
            this.previous.xa(this.element);
            this.previous.La("click", this.AU, this);
            g.I(this, this.N);
            for (a = {
                    xt: 0
                }; 16 > a.xt; a = {
                ...
                d.xa(this.suggestions.element);
                var e = d.ya("ytp-suggestion-link");
                g.bl(e, "transitionDelay", a.xt / 20 + "s");
                this.j.P(e, "click", function(f) {
                    return function(k) {
                        var l = f.xt;
                        if (1E3 > (0, g.Q)() - c.W) g.rt(k), document.activeElement.blur();
                        else {
                            l = c.suggestionData[l];
                            var m = l.sessionData;
                            g.xJ(k, c.api, c.J, m || void 0) && c.api.wl(l.videoId, m, l.playlistId)
                        }
                    }
                }(a));
                this.B.push(d)
            ...
            g.I(this, this.next);
            this.next.xa(this.element);
            this.next.La("click", this.zU, this);
            b = new g.V({
                F: "button",
            ...
            g.I(this, b);
            b.xa(this.element);
            b.La("click", this.qY, this);
            g.I(this, this.expandButton);
            this.expandButton.xa(this.element);
            this.expandButton.La("click", this.rY, this);
        ...
        IXa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                d.element.style.display = "";
                g.TSa.test(c.title) && (d.ya("ytp-suggestion-title").dir = "rtl");
                g.TSa.test(e) && (d.ya("ytp-suggestion-author").dir = "rtl");
                var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.xH(c.lengthSeconds) : "";
                var k = c.mm();
                if (g.aB(a.api.S())) {
                    var l = {};
                    a.api.S().ma && g.pI(l, a.api.S().loaderUrl);
                    k = g.Sh(k, g.oI(l, "emb_rel_pause"))
                }
                d.update({
                    author_and_views: e,
                    duration: f,
                    ...
                    blink_rendering_hack: g.qz || g.ZA ? "will-change: opacity" : void 0
                });
                d = d.ya("ytp-suggestion-image");
                c = c.Bf();
                d.style.backgroundImage = c ? "url(" + c + ")" : ""
        ...
        E2 = function(a) {
            ...
            g.V.call(this, {
                ...
                T: {
                    target: b.J,
                    href: "{{url}}",
                    "aria-label": g.iF("Watch on $WEBSITE", {
                        WEBSITE: g.wB(b)
                    }),
            ...
            this.P(a, "videodatachange", this.hK);
        ...
        G2 = function(a, b) {
            a = {
                ...
                embedUrl: g.Oda(a.G.S().loaderUrl),
                eventType: b,
                youtubeHost: g.Mh(a.G.S().Y) || ""
            };
            g.yr("embedsAdEvent", a)
        };
    g.w(t2, g.G);
    ...
    t2.prototype.next = function() {
        ...
        var b = this.u;
        a = CXa(b, a / this.duration);
        if (0 == a) b = b.J;
        else if (1 == a) b = b.N;
        else {
            var c = g.eg(b.J, b.D, a),
                d = g.eg(b.D, b.I, a);
            b = g.eg(b.I, b.N, a);
            c = g.eg(c, d, a);
            d = g.eg(d, b, a);
    ...
    g.h.resize = function(a, b) {
        ...
        if (150 >= Math.min(a.width, a.height) || 0 === k || !c.Kc) this.hide();
        else {
            var l;
            if (e) {
                var m = l = 28;
            ...
            b && m + 100 > b && 50 < l && (m = Math.max(b, 50 / d), l = Math.ceil(a / (d * (m - 100) + this.j)), l = a / l - this.j,
                m = Math.floor(l / d));
            50 > l || g.HI(this.api) ? this.hide() : this.show();
            for (b = 0; b < k; b++) {
                d = this.B[b];
    ...
    g.h.onVideoDataChange = function() {
        var a = this.api.getVideoData(),
            b = this.api.S();
        this.J = a.D ? !1 : b.j;
        a.suggestions ? this.suggestionData = g.fm(a.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        DXa(this);
        a.D ? this.title.update({
            title: g.iF("More videos from $DNI_RELATED_CHANNEL", {
    ...
    g.h.scrollTo = function(a) {
        a = g.cg(a, this.containerWidth - this.suggestionData.length * (this.tileWidth + this.j), 0);
    ...
    w2.prototype.show = function() {
        g.CJ.prototype.show.call(this);
        FXa(this, this.api.Ya().getPlayerSize())
    };
    w2.prototype.resize = function(a) {
        g.CJ.prototype.resize.call(this, a);
        this.j && (FXa(this, a), g.N(this.element, "related-on-error-overlay-visible", !this.j.isHidden()))
    };
    w2.prototype.u = function(a) {
        g.CJ.prototype.u.call(this, a);
        var b = this.api.getVideoData();
        if (b.lG || b.playerErrorMessageRenderer)(a = b.lG) ? GXa(this, a) : b.playerErrorMessageRenderer && GXa(this, b.playerErrorMessageRenderer);
        else {
            var c;
            a.Ek && (b.Vr ? x2(b.Vr) ? c = g.Tv(b.Vr) : c = g.DJ(g.Sv(b.Vr)) : c = g.DJ(a.Ek), this.Ld(c, "subreason"))
        }
    };
    g.w(y2, g.V);
    y2.prototype.eh = function() {
        this.api.xb().isCued() || (this.hide(), this.api.Va(this.element, !1))
    };
    y2.prototype.j = function() {
        var a = this.api.getVideoData(),
            b = this.api.S(),
            ...
            k = g.lB(b);
        b = b.C;
        d || f || c || e || k || b || !a.videoId ? (this.hide(), this.api.Va(this.element, !1)) : (a = HXa(this), this.Ha("url", a), this.show())
    };
    ...
    y2.prototype.show = function() {
        this.api.xb().isCued() && (g.V.prototype.show.call(this), this.api.Jn(this.element) && this.api.Va(this.element, !0))
    };
    g.w(z2, g.V);
    z2.prototype.eh = function() {
        var a = this.api.xb();
        !this.api.Sf() || g.U(a, 2) && g.EI(this.api) || g.U(a, 64) ? (this.api.Va(this.j, !1), this.api.Va(this.forwardButton, !1), this.hide()) : (this.show(), this.api.Va(this.j, !0), this.api.Va(this.forwardButton, !0))
    };
    ...
    g.w(A2, g.V);
    A2.prototype.u = function() {
        var a = this.api.xb(),
            b = this.api.getVideoData();
        this.api.S().K("embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.U(a, 2) && !this.ob ? (this.show(), this.j.show(), a = this.api.getVideoData(), this.Ha("text", a.OL), g.N(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.Va(this.element, this.ob), this.api.Ma("onMutedAutoplayEnds")) : this.hide())
    };
    A2.prototype.onClick = function() {
        var a = this.api.getVideoData(),
    ...
    B2.prototype.j = function() {
        var a = this.api.xb(),
            b = this.api.getVideoData();
        this.api.S().K("embeds_enable_muted_autoplay") && b.mutedAutoplay && !g.U(a, 2) ? this.ob || (g.V.prototype.show.call(this), this.B.start(), this.api.Va(this.element, this.ob)) : this.hide()
    };
    B2.prototype.u = function() {
        g.N(this.element, "ytp-muted-autoplay-hide-watermark", !0)
    };
    B2.prototype.onClick = function() {
        var a = this.api.getVideoData(),
            b = this.api.getCurrentTime();
        a.mutedAutoplay = !1;
        a.endSeconds = NaN;
    ...
    g.h.Wc = function(a) {
        if (!(g.U(a.state, 1) || g.U(a.state, 16) || g.U(a.state, 32))) {
            var b = !this.api.S().K("embeds_disable_pauseoverlay_on_autoplay_blocked_killswitch") && g.U(a.state, 1024);
            !g.U(a.state, 4) || g.U(a.state, 2) || b ? this.C.hide() : this.suggestionData.length && (this.D || (g.ho(this.api.getRootNode(), "ytp-expand-pause-overlay"), D2(this)), this.C.show(), this.W = (0, g.Q)())
        }
    };
    g.h.wb = function(a) {
        var b = 16 / 9,
    ...
    g.h.onVideoDataChange = function() {
        var a = this.api.S(),
            b = this.api.getVideoData();
        this.J = b.D ? !1 : a.j;
        b.suggestions ? this.suggestionData = g.fm(b.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        IXa(this);
    ...
    g.h.hK = function() {
        var a = this.api.getVideoData(),
            ...
            c = this.api.S();
        a = (a.mutedAutoplay || c.Nc && !g.U(this.state, 2)) && !(b && c.pfpChazalUi);
        g.yG(this, a);
    ...
    g.h.onVideoDataChange = function() {
        if (this.api.getVideoData().videoId) {
            ...
            this.Ha("url", a);
            this.j || (this.j = this.La("click", this.onClick))
        } else this.j && (this.Ha("url", null), this.xc(this.j), this.j = null)
    };
    g.h.onClick = function(a) {
        var b = this.api.getVideoUrl(!g.yH(a), !1, !0, !0);
        g.yJ(b, this.api, a);
        this.api.sb(this.element)
    };
    g.h.wb = function(a) {
    ...
    g.h.create = function() {
        ...
        d && g.rw("cpn", d);
        a.Kc && !a.C && (this.I = new C2(this.G, b), g.I(this, this.I), g.KI(this.G, this.I.element, 4));
        a.K("embeds_enable_muted_autoplay") && (this.u = new B2(this.G), g.I(this, this.u), g.KI(this.G, this.u.element, 4), this.D = new A2(this.G), g.I(this, this.D), g.KI(this.G, this.D.element, 4));
        if (a.Nc || this.u) this.watermark = new E2(this.G), g.I(this, this.watermark), g.KI(this.G, this.watermark.element,
            8);
        this.B = new y2(this.G, b);
        g.I(this, this.B);
        g.KI(this.G, this.B.element, 8);
        a.isMobile && (this.C = new z2(this.G), g.I(this, this.C), g.KI(this.G, this.C.element, 4));
        this.j.P(this.G, "appresize", this.wb);
        this.j.P(this.G, "presentingplayerstatechange", this.eh);
        this.j.P(this.G, "videodatachange", this.l1);
        ...
        this.Tb(this.G.xb());
        this.player.mf("embed")
    };
    g.h.wb = function() {
        var a = this.G.Ya().getPlayerSize();
        this.sf && this.sf.resize(a)
    };
    g.h.eh = function(a) {
        this.Tb(a.state)
    };
    g.h.Tb = function(a) {
        g.U(a, 128) ? (this.sf || (this.sf = new w2(this.G), g.I(this, this.sf), g.KI(this.G, this.sf.element, 4)), this.sf.u(a.getData()), this.sf.show(), g.ho(this.G.getRootNode(), "ytp-embed-error")) : this.sf && (this.sf.dispose(), this.sf = null, g.jo(this.G.getRootNode(), "ytp-embed-error"))
    };
    ...
    g.h.l1 = function() {
        ...
        this.watermark && this.u && !a.mutedAutoplay && g.Mg(this.u.element, this.watermark.element) && g.KI(this.G, this.watermark.element, 8)
    };
    g.h.onAdStart = function() {
        G2(this, "EMBEDS_AD_EVENT_TYPE_AD_STARTED")
    };
    g.h.onAdComplete = function() {
        G2(this, "EMBEDS_AD_EVENT_TYPE_AD_COMPLETED")
    };
    g.h.onAdSkip = function() {
        G2(this, "EMBEDS_AD_EVENT_TYPE_AD_SKIPPED")
    };
    g.h.onAdStateChange = function(a) {
        2 === a && G2(this, "EMBEDS_AD_EVENT_TYPE_AD_PAUSED")
    };
    g.XI("embed", F2);
})(_yt_player);