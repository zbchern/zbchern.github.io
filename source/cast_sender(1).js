(function() {
    ...
    */
    ...
    var Ea = function(a) {
            ...
            sa("expected object of type SafeHtml, got '" + a + "' of type " + la(a));
            return "type_error:SafeHtml"
        },
        Fa = new B(r.trustedTypes && r.trustedTypes.emptyHTML || "", 0, Da);
    var Ga = {
            MATH: !0,
            SCRIPT: !0,
            STYLE: !0,
    ...
    var Ja = function(a) {
            ...
            return a.replace(Ia, function(d, e) {
                var h = b[d];
                if (h) return h;
                ...
                if (!h) {
                    ...
                    h = (e = z) ? e.createHTML(h) :
                        h;
                    h = new B(h, null, Da);
                    if (c.tagName && Ga[c.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " + c.tagName + ".");
                    if (Ha())
    ...
    chrome.cast.zb = function(a, b, c, d) {
        this.label = a;
        a = b;
        Ba.test(a) && (-1 != a.indexOf("&") && (a = a.replace(va, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(wa, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(xa, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(ya, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(za, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(Aa, "&#0;")));
        this.friendlyName = a;
        this.capabilities = c || [];
        this.volume = d || null;
    ...
    f.U = function(a, b, c) {
        ...
        C.s(this, "MEDIA_GET_STATUS", a, b, c, chrome.cast.media.timeout.U)
    };
    ...
    f.V = function(a, b, c) {
        C.s(this, "MEDIA_SET_VOLUME", a, b, c, chrome.cast.media.timeout.V)
    };
    f.T = function(a, b, c) {
        C.s(this, "EDIT_TRACKS_INFO", a, b, c, chrome.cast.media.timeout.T)
    };
    f.kc = function(a, b, c) {
        C.s(this, "QUEUE_INSERT", a, b, c, chrome.cast.media.timeout.A)
    };
    f.jc = function(a, b, c) {
        C.s(this, "QUEUE_INSERT", new chrome.cast.media.va([a]), b, c, chrome.cast.media.timeout.A)
    };
    f.uc = function(a, b, c) {
    ...
    f.qc = function(a, b, c) {
        0 > La(this, a) || C.s(this, "QUEUE_REMOVE", new chrome.cast.media.xa([a]), b, c, chrome.cast.media.timeout.A)
    };
    f.sc = function(a, b, c) {
    ...
    f.Ua = function(a, b, c) {
        a.Oa(new Oa(this.sessionId), b, c, chrome.cast.timeout.stopSession)
    };
    f.sendMessage = function(a, b, c, d) {
        this.Qa(C, a, b, c, d)
    };
    f.Qa = function(a, b, c, d, e) {
        a.zc(new Ma(this.sessionId, b, c), d, e)
    };
    f.aa = function(a) {
        this.N(C, a)
    };
    ...
    f.mc = function(a, b, c) {
        a.sessionId = this.sessionId;
        C.Pa(a, "QUEUE_LOAD", b, c)
    };
    x("chrome.cast.Session", chrome.cast.j);
    chrome.cast.j.prototype.queueLoad = chrome.cast.j.prototype.mc;
    chrome.cast.j.prototype.loadMedia = chrome.cast.j.prototype.fc;
    chrome.cast.j.prototype.removeMessageListenerWithContext = chrome.cast.j.prototype.Ma;
    chrome.cast.j.prototype.removeMessageListener = chrome.cast.j.prototype.xc;
    ...
    chrome.cast.j.prototype.addMediaListener = chrome.cast.j.prototype.Z;
    chrome.cast.j.prototype.addMessageListenerWithContext = chrome.cast.j.prototype.Ga;
    chrome.cast.j.prototype.addMessageListener = chrome.cast.j.prototype.Xb;
    chrome.cast.j.prototype.removeUpdateListenerWithContext = chrome.cast.j.prototype.P;
    chrome.cast.j.prototype.removeUpdateListener = chrome.cast.j.prototype.da;
    chrome.cast.j.prototype.addUpdateListenerWithContext = chrome.cast.j.prototype.N;
    ...
    chrome.cast.j.prototype.leave = chrome.cast.j.prototype.ec;
    ...
    chrome.cast.j.prototype.setReceiverMuted = chrome.cast.j.prototype.Cc;
    chrome.cast.j.prototype.setReceiverVolumeLevelWithContext = chrome.cast.j.prototype.Sa;
    chrome.cast.j.prototype.setReceiverVolumeLevel = chrome.cast.j.prototype.Dc;
    var Pa = function(a, b) {
        this.g = a[r.Symbol.iterator]();
        this.i = b
    };
    Pa.prototype[Symbol.iterator] = function() {
        return this
    };
    ...
    var Ra = Object.freeze || function(a) {
        return a
    };
    ...
    var M = function(a, b) {
            return L(a.g, b) ? (delete a.g[b], --a.size, a.i++, a.o.length > 2 * a.size && K(a), !0) : !1
        },
        K = function(a) {
    ...
    f.set = function(a, b) {
        L(this.g, a) || (this.size += 1, this.o.push(a), this.i++);
        this.g[a] = b
    };
    f.keys = function() {
        return Wa(this.u(!0)).l()
    };
    f.values = function() {
        return Wa(this.u(!1)).l()
    };
    f.entries = function() {
        var a = this;
        return Qa(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    };
    f.u = function(a) {
    ...
    P.prototype.connect = function(a) {
        ...
        ab(this, new O("client_connect", this.i))
    };
    ...
    var db = function(a, b, c, d, e, h, k, l, p, v, kb, lb) {
            this.K = a;
            this.g = b || null;
            this.l = c || null;
            this.C = d || null;
        ...
        eb = function(a) {
            ...
            a.i && b.push(cb(new bb(a.i, a.J, a.g)));
            return b
        };
    var fb = function() {
            this.g = {};
    ...
    var mb = A("Gecko") && !(-1 != Ca().toLowerCase().indexOf("webkit") && !A("Edge")) && !(A("Trident") || A("MSIE")) && !A("Edge"),
        nb = -1 != Ca().toLowerCase().indexOf("webkit") && !A("Edge");
    try {
    ...
    var qb = {},
        S = null,
        rb = mb || nb || "function" == typeof r.btoa,
        sb = function(a) {
            if (rb) var b = r.btoa(a);
            else {
                b = [];
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = ab(a.B, b);
            c && d && (a =
                $a(a.L, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.D.INVALID_PARAMETER, d), (a = a.g) && a(b))
        };
    ...
    var Y = function(a, b, c) {
            ...
            b.onclose = function(d) {
                ...
                switch (d.reason) {
                    case "closed":
                        vb(a, chrome.cast.M.DISCONNECTED);
                        break;
                    case "error":
        ...
        yb = function(a) {
            var b = Z;
            wb.has(a.type) && b.la && (b.m ? (a.sessionId = b.m, xb(b, null, a.type, a, function() {}, function() {})) : b.jb.B(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.l ? ub(b) : (c = X(this, c), this.l = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.l = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName, (h = k.launchParameter) && !h.match(zb) && (h = sb(h)));
        var l = [];
        l.push({
            appId: b.appId,
            capabilities: b.capabilities
        });
        b || ta(a.g.additionalSessionRequests, function(p) {
            l.push({
                appId: p.appId,
                capabilities: p.capabilities
            })
        });
        return eb(new db(l, a.B.i, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, e, h, a.g.invisibleSender, c, d, b.androidReceiverCompatible, b.credentialsData))
    };
    V.prototype.Pa = function(a, b, c, d) {
        var e = this;
        this.F++;
        xb(this, null, b, a, function(h) {
            e.F--;
            h.l = !0;
            c && c(h)
        }, function(h) {
    ...
    V.prototype.s = function(a, b, c, d, e, h) {
        var k = this;
        xb(this, a, b, c, function(l) {
            k.Ha(l);
            d && d(void 0)
        }, e, h)
    };
    var xb = function(a, b, c, d, e, h, k) {
        d.type = c;
    ...
    var vb = function(a, b) {
        if (a.m) {
            ...
            gb(a.I, c, b) && (M(a.v, c), M(a.J, c), b = a.C.get(c)) && (M(a.C, c), F(b.u(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        switch (a.type) {
            case "new_session":
            case "update_session":
                a.message = ib(this.I, a.message);
                break;
            case "v2_message":
                var b = a.message;
                b && "MEDIA_STATUS" == b.type && b.status && (b.status = b.status.map(this.kb))
        }
        if (b = $a(this.L, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    ...
    var Cb = function(a, b) {
        ...
        zb = RegExp("^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$"),
        wb = new Set(["PRECACHE"]),
        Z = new V;
    ...
    chrome.cast.unescape = function(a) {
        return -1 != a.indexOf("&") ? "document" in r ? Ja(a) : Ka(a) : a
    };
